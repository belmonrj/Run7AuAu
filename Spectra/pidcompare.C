...
void doit(int sector=0, int partid=0, int centid=0)
{
  ...
  float pT1[45], epT1[45], ratio1[45], eratio1[45], esysratio1[45];
  float pT2[45], epT2[45], ratio2[45], eratio2[45], esysratio2[45];
  float pT3[45], epT3[45], ratio3[45], eratio3[45], esysratio3[45];
  ...
  TGraphErrors *tge_poscb1SYS = new TGraphErrors(number+offset,pT1,ratio1,epT1,esysratio1);
  tge_poscb1SYS->SetMarkerColor(kGray);
  tge_poscb1SYS->SetMarkerStyle(1);
  tge_poscb1SYS->SetLineWidth(15);
  tge_poscb1SYS->SetLineColor(kGray);
  TGraphErrors *tge_poscb2SYS = new TGraphErrors(number+offset,pT2,ratio2,epT2,esysratio2);
  tge_poscb2SYS->SetMarkerColor(kRed-10);
  tge_poscb2SYS->SetMarkerStyle(1);
  tge_poscb2SYS->SetLineWidth(15);
  tge_poscb2SYS->SetLineColor(kRed-10);
  // TGraphErrors *tge_poscb3 = new TGraphErrors(number+offset,pT3,ratio3,epT3,esysratio3);
  // tge_poscb3SYS->SetMarkerColor(kBlue);
  // tge_poscb3SYS->SetMarkerStyle(1);
  ...
  TGraphErrors *tge_negcb1SYS = new TGraphErrors(number+offset,pT1,ratio1,epT1,esysratio1);
  tge_negcb1SYS->SetMarkerColor(kGray);
  tge_negcb1SYS->SetMarkerStyle(1);
  tge_negcb1SYS->SetLineWidth(15);
  tge_negcb1SYS->SetLineColor(kGray);
  TGraphErrors *tge_negcb2SYS = new TGraphErrors(number+offset,pT2,ratio2,epT2,esysratio2);
  tge_negcb2SYS->SetMarkerColor(kRed-10);
  tge_negcb2SYS->SetMarkerStyle(1);
  tge_negcb2SYS->SetLineWidth(15);
  tge_negcb2SYS->SetLineColor(kRed-10);
  ...
  TGraphErrors *tge2_poscb1SYS = new TGraphErrors(12,pT1,ratio1,epT1,esysratio1);
  tge2_poscb1SYS->SetMarkerColor(kGray);
  tge2_poscb1SYS->SetMarkerStyle(1);
  tge2_poscb1SYS->SetLineWidth(15);
  tge2_poscb1SYS->SetLineColor(kGray);
  TGraphErrors *tge2_poscb2SYS = new TGraphErrors(12,pT2,ratio2,epT2,esysratio2);
  tge2_poscb2SYS->SetMarkerColor(kRed-10);
  tge2_poscb2SYS->SetMarkerStyle(1);
  tge2_poscb2SYS->SetLineWidth(15);
  tge2_poscb2SYS->SetLineColor(kRed-10);
  ...
  TGraphErrors *tge2_negcb1SYS = new TGraphErrors(12,pT1,ratio1,epT1,esysratio1);
  tge2_negcb1SYS->SetMarkerColor(kBlack);
  tge2_negcb1SYS->SetMarkerStyle(1);
  tge2_negcb1SYS->SetLineWidth(15);
  tge2_negcb1SYS->SetLineColor(kGray);
  TGraphErrors *tge2_negcb2SYS = new TGraphErrors(12,pT2,ratio2,epT2,esysratio2);
  tge2_negcb2SYS->SetMarkerColor(kRed);
  tge2_negcb2SYS->SetMarkerStyle(1);
  tge2_negcb2SYS->SetLineWidth(15);
  tge2_negcb2SYS->SetLineColor(kRed-10);
  ...
  tmg_pos_cb->Add(tge_poscb1SYS);
  if(pion) tmg_pos_cb->Add(tge2_poscb1SYS);
  tmg_pos_cb->Add(tge_poscb2SYS);
  if(pion) tmg_pos_cb->Add(tge2_poscb2SYS);
  ...
  TPaveText *pave_pos_cb = new TPaveText(1.03, 0.1, 2.5, 0.3, "br");
  if(kaon) pave_pos_cb = new TPaveText(0.51, 0.1, 1.25, 0.3, "br");
  ...
  if(kaon) pave2_pos_cb = new TPaveText(0.25, 2.04, 2.75, 2.2, "br");
  pave2_pos_cb->SetFillColor(10);
  pave2_pos_cb->SetBorderSize(0);
  TText *text2_pos_cb = pave2_pos_cb->AddText("Au+Au  #sqrt{s_{NN}} = 200 GeV");
  pave2_pos_cb->Draw();
  
  TLegend *leg_pos_cb = new TLegend(0.75,0.18,0.88,0.38);
  leg_pos_cb->SetFillColor(kWhite);
  leg_pos_cb->SetBorderSize(0);
  // leg_pos_cb->AddEntry(tge_poscb1,"#pi^{+}, regular","p");
  // if(pion) leg_pos_cb->AddEntry(tge2_poscb1,"#pi^{+}, regular","p");
  // leg_pos_cb->AddEntry(tge_poscb2,"#pi^{+}, pid+ep","p");
  // if(pion) leg_pos_cb->AddEntry(tge2_poscb2,"#pi^{+}, pid+ep","p");
  leg_pos_cb->AddEntry(tge_poscb1,"regular","p");
  if(pion) leg_pos_cb->AddEntry(tge2_poscb1,"regular","p");
  leg_pos_cb->AddEntry(tge_poscb2,"pid+ep","p");
  if(pion) leg_pos_cb->AddEntry(tge2_poscb2,"pid+ep","p");
  leg_pos_cb->Draw();
  ...
  tmg_neg_cb->Add(tge_negcb1SYS);
  if(pion) tmg_neg_cb->Add(tge2_negcb1SYS);
  tmg_neg_cb->Add(tge_negcb2SYS);
  if(pion) tmg_neg_cb->Add(tge2_negcb2SYS);
  ...
  if(kaon) tmg_neg_cb->GetXaxis()->SetLimits(0.0,3.0);//oops
  ...
  TPaveText *pave_neg_cb = new TPaveText(1.03, 0.1, 2.5, 0.3, "br");
  if(kaon) pave_neg_cb = new TPaveText(0.51, 0.1, 1.25, 0.3, "br");
  ...
  if(kaon) pave2_neg_cb = new TPaveText(0.25, 2.04, 2.75, 2.2, "br");
  pave2_neg_cb->SetFillColor(10);
  pave2_neg_cb->SetBorderSize(0);
  TText *text2_neg_cb = pave2_neg_cb->AddText("Au+Au  #sqrt{s_{NN}} = 200 GeV");
  pave2_neg_cb->Draw();
  
  TLegend *leg_neg_cb = new TLegend(0.75,0.18,0.88,0.38);
  leg_neg_cb->SetFillColor(kWhite);
  leg_neg_cb->SetBorderSize(0);
  leg_neg_cb->AddEntry(tge_negcb1,"regular","p");
  //if(pion) leg_neg_cb->AddEntry(tge2_negcb1,"regular","p");
  leg_neg_cb->AddEntry(tge_negcb2,"pid+ep","p");
  //if(pion) leg_neg_cb->AddEntry(tge2_negcb2,"pid+ep","p");
  // leg_neg_cb->AddEntry(tge_negcb1,"#pi^{-}, regular","p");
  // if(pion) leg_neg_cb->AddEntry(tge2_negcb1,"#pi^{-}, regular","p");
  // leg_neg_cb->AddEntry(tge_negcb2,"#pi^{-}, pid+ep","p");
  // if(pion) leg_neg_cb->AddEntry(tge2_negcb2,"#pi^{-}, pid+ep","p");
  leg_neg_cb->Draw();
  ...
  // now calculate ratio of 2/1



  float pTratio12pos[45],epTratio12pos[45];
  float yIratio12pos[45],eyIratio12pos[45];
  float pTratio12neg[45],epTratio12neg[45];
  float yIratio12neg[45],eyIratio12neg[45];
  ...
  for(int i=0; i<40; i++)
    {
      // pos
      epTratio12pos[i] = 0;
      pTratio12pos[i] = pT_poscb1[i];
      if(yield_poscb1[i]>0&&yield_poscb2[i]>0)
	{
	  //yIratio12pos[i] = yield_poscb1[i]/yield_poscb2[i];
	  yIratio12pos[i] = yield_poscb2[i]/yield_poscb1[i];
	  eyIratio12pos[i] = yIratio12pos[i]*sqrt((eyield_poscb1[i]/yield_poscb1[i])**2+(eyield_poscb2[i]/yield_poscb2[i])**2);
	}
      else 
	{
	  yIratio12pos[i]= -9;
      ...
      // neg
      epTratio12neg[i] = 0;
      pTratio12neg[i] = pT_negcb1[i];
      if(yield_negcb1[i]>0&&yield_negcb2[i]>0)
	{
	  //yIratio12neg[i] = yield_negcb1[i]/yield_negcb2[i];
	  yIratio12neg[i] = yield_negcb2[i]/yield_negcb1[i];
	  eyIratio12neg[i] = yIratio12neg[i]*sqrt((eyield_negcb1[i]/yield_negcb1[i])**2+(eyield_negcb2[i]/yield_negcb2[i])**2);
	}
      else 
	{
	  yIratio12neg[i]= -9;
  ...
  for(int i=40; i<45; i++)
    {
      ...
      int k = i-32; // test
      epTratio12pos[i] = 0;
      pTratio12pos[i] = pTR_poscb1[k];
      //cout<<"i is "<<i<<" and k is "<<k<<" and pT is "<<pTR_poscb1[k]<<endl;
      if(yieldR_poscb1[k]>0&&yieldR_poscb2[k]>0)
	{
	  //yIratio12pos[i] = yieldR_poscb1[k]/yieldR_poscb2[k];
	  yIratio12pos[i] = yieldR_poscb2[k]/yieldR_poscb1[k];
	  eyIratio12pos[i] = yIratio12pos[k]*sqrt((eyieldR_poscb1[k]/yieldR_poscb1[k])**2+(eyieldR_poscb2[k]/yieldR_poscb2[k])**2);
	}
      else 
	{
	  yIratio12pos[i]= -9;
      ...
      if(kaon) // clean the kaons above 4
	{
	  yIratio12pos[i]= -9;
	  eyIratio12pos[i]= 0;
	}
      ...
      int k = i-32; // test
      epTratio12neg[i] = 0;
      pTratio12neg[i] = pTR_negcb1[k];
      //cout<<"i is "<<i<<" and k is "<<k<<" and pT is "<<pTR_negcb1[k]<<endl;
      if(yieldR_negcb1[k]>0&&yieldR_negcb2[k]>0)
	{
	  //yIratio12neg[i] = yieldR_negcb1[k]/yieldR_negcb2[k];
	  yIratio12neg[i] = yieldR_negcb2[k]/yieldR_negcb1[k];
	  eyIratio12neg[i] = yIratio12neg[k]*sqrt((eyieldR_negcb1[k]/yieldR_negcb1[k])**2+(eyieldR_negcb2[k]/yieldR_negcb2[k])**2);
	}
      else 
	{
	  yIratio12neg[i]= -9;
  ...
  for(int i=0; i<5; i++)
    {
      if(pion&&i<2) yIratio12pos[i]= -9;
      if(kaon&&i<4) yIratio12pos[i]= -9;
      if(proton) yIratio12pos[i]= -9;
      if(pion&&i<2) yIratio12neg[i]= -9;
      if(kaon&&i<4) yIratio12neg[i]= -9;
      if(proton) yIratio12neg[i]= -9;
    }
  ...
  TGraphErrors *tge_ratio12pos = new TGraphErrors(45,pTratio12pos,yIratio12pos,epTratio12pos,eyIratio12pos);
  tge_ratio12pos->SetMarkerColor(kRed);
  tge_ratio12pos->SetMarkerStyle(kFullCircle);

  tge_ratio12pos->Draw("ap");
  tge_ratio12pos->SetMaximum(2.0);
  tge_ratio12pos->SetMinimum(0.0);
  tge_ratio12pos->GetXaxis()->SetLimits(0.0,6.0);
  //if(kaon) tge_ratio12pos->GetXaxis()->SetLimits(0.0,4.0);//oops
  tge_ratio12pos->GetXaxis()->SetTitle("p_{T} (GeV/c)");
  tge_ratio12pos->GetXaxis()->CenterTitle();
  tge_ratio12pos->GetYaxis()->SetTitle("Ratio");
  tge_ratio12pos->GetYaxis()->CenterTitle();

  TPaveText *pave_ratio12pos = new TPaveText(1.03, 0.1, 2.5, 0.3, "br");
  //if(kaon) pave_ratio12pos = new TPaveText(0.51, 0.1, 1.25, 0.3, "br"); // need to check
  pave_ratio12pos->SetFillColor(10);
  pave_ratio12pos->SetBorderSize(0);
  TText *text_ratio12pos = pave_ratio12pos->AddText(bigcentstring);
  pave_ratio12pos->Draw();

  //TLegend *leg_ratio12pos = new TLegend(0.18,0.27,0.48,0.33);
  TLegend *leg_ratio12pos = new TLegend(0.58,0.82,0.88,0.88);
  leg_ratio12pos->SetFillColor(kWhite);
  leg_ratio12pos->SetBorderSize(0);
  //leg_ratio12pos->AddEntry(tge_ratio12pos,"withepcut/without","p");
  leg_ratio12pos->AddEntry(tge_ratio12pos,"withemcmatch/without","p");
  //leg_ratio12pos->Draw();

  //c1->Print("temp.gif");

  char gifname_pos[100];
  sprintf(gifname_pos,"RatioFigures/pidcompare_RATIO_%s_pos_%d_dis_cent%s.gif",sectorstring,pid,centstring);
  c1->Print(gifname_pos);
  char epsname_pos[100];
  sprintf(epsname_pos,"RatioFigures/pidcompare_RATIO_%s_pos_%d_dis_cent%s.eps",sectorstring,pid,centstring);
  ...
  TGraphErrors *tge_ratio12neg = new TGraphErrors(45,pTratio12neg,yIratio12neg,epTratio12neg,eyIratio12neg);
  tge_ratio12neg->SetMarkerColor(kRed);
  tge_ratio12neg->SetMarkerStyle(kFullCircle);

  tge_ratio12neg->Draw("ap");
  tge_ratio12neg->SetMaximum(2.0);
  tge_ratio12neg->SetMinimum(0.0);
  tge_ratio12neg->GetXaxis()->SetLimits(0.0,6.0);
  //if(kaon) tge_ratio12neg->GetXaxis()->SetLimits(0.0,4.0);//oops
  tge_ratio12neg->GetXaxis()->SetTitle("p_{T} (GeV/c)");
  tge_ratio12neg->GetXaxis()->CenterTitle();
  tge_ratio12neg->GetYaxis()->SetTitle("Ratio");
  tge_ratio12neg->GetYaxis()->CenterTitle();

  TPaveText *pave_ratio12neg = new TPaveText(1.03, 0.1, 2.5, 0.3, "br");
  //if(kaon) pave_ratio12neg = new TPaveText(0.51, 0.1, 1.25, 0.3, "br"); // need to check
  pave_ratio12neg->SetFillColor(10);
  pave_ratio12neg->SetBorderSize(0);
  TText *text_ratio12neg = pave_ratio12neg->AddText(bigcentstring);
  pave_ratio12neg->Draw();

  //TLegend *leg_ratio12neg = new TLegend(0.18,0.27,0.48,0.33);
  TLegend *leg_ratio12neg = new TLegend(0.58,0.82,0.88,0.88);
  leg_ratio12neg->SetFillColor(kWhite);
  leg_ratio12neg->SetBorderSize(0);
  //leg_ratio12neg->AddEntry(tge_ratio12neg,"withepcut/without","p");
  leg_ratio12neg->AddEntry(tge_ratio12neg,"withemcmatch/without","p");
  //leg_ratio12neg->Draw();

  //c1->Print("temp.gif");

  char gifname_neg[100];
  sprintf(gifname_neg,"RatioFigures/pidcompare_RATIO_%s_neg_%d_dis_cent%s.gif",sectorstring,pid,centstring);
  c1->Print(gifname_neg);
  char epsname_neg[100];
  sprintf(epsname_neg,"RatioFigures/pidcompare_RATIO_%s_neg_%d_dis_cent%s.eps",sectorstring,pid,centstring);
