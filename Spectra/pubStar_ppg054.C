...
void doit(int sector=0, int partid=0, int centid=0)
{
  ...
  for(int i=0; i<21; i++)
    {
      fin080>>pT_ppg054[i+2]>>yield_ppg054[i+2]>>eyield_ppg054[i+2];
    }
  fin080.close();
  ...
  if(pid==4||pid==5) tmgS_poscb->GetXaxis()->SetLimits(0.0,4.0);
  if(pid>=6) tmgS_poscb->GetXaxis()->SetLimits(0.0,7.0);
  ...
  sprintf(gifname_poscb,"RatioFigures/STAR_ppg054_published_%s_pos_%d_dis_cent%s.gif",sectorstring,pid,centstring);
  char epsname_poscb[100];
  sprintf(epsname_poscb,"RatioFigures/STAR_ppg054_published_%s_pos_%d_dis_cent%s.eps",sectorstring,pid,centstring);
  ...
  if(pid==4||pid==5) tmgS_negcb->GetXaxis()->SetLimits(0.0,4.0);
  if(pid>=6) tmgS_negcb->GetXaxis()->SetLimits(0.0,7.0);
  ...
  sprintf(gifname_negcb,"RatioFigures/STAR_ppg054_published_%s_neg_%d_dis_cent%s.gif",sectorstring,pid,centstring);
  char epsname_negcb[100];
  sprintf(epsname_negcb,"RatioFigures/STAR_ppg054_published_%s_neg_%d_dis_cent%s.eps",sectorstring,pid,centstring);
  ...
  if(pid<=3)
      ...
      for(int i=0; i<14; i++)
	{
      ...
      TGraphErrors *tge2_poscb = new TGraphErrors(14,pT,ratio,epT,eratio);
      tge2_poscb->SetMarkerColor(kRed);
      tge2_poscb->SetMarkerStyle(21);
      TGraphErrors *tge2_poscbSYS = new TGraphErrors(14,pT,ratio,epT,esysratio);
      ...
      for(int i=0; i<14; i++)
	{
      ...
      TGraphErrors *tge2_negcb = new TGraphErrors(14,pT,ratio,epT,eratio);
      tge2_negcb->SetMarkerColor(kRed);
      tge2_negcb->SetMarkerStyle(21);
      TGraphErrors *tge2_negcbSYS = new TGraphErrors(14,pT,ratio,epT,esysratio);
      ...
      tmg_pos_cb->GetXaxis()->SetLimits(0.0,7.0);
      ...
      TPaveText *pave_pos_cb = new TPaveText(1.01, 0.1, 2.5, 0.4, "br");
      ...
      TLegend *leg_pos_cb = new TLegend(0.18,0.68,0.48,0.88);
      leg_pos_cb->SetFillColor(kWhite);
      leg_pos_cb->SetBorderSize(0);
      leg_pos_cb->AddEntry(tge_poscb,"#pi^{+}, Run7/PPG026","p");
      leg_pos_cb->AddEntry(tge2_poscb,"#pi^{+}, Run7/PPG054","p");
      leg_pos_cb->AddEntry(tge_starposcb,"#pi^{+}, Run7/STAR","p");
      leg_pos_cb->Draw();
      
      char gifname_pos_cb[100];
      sprintf(gifname_pos_cb,"RatioFigures/STAR_ppg054_published_%s_pos_%d_dis_cent%s.gif",sectorstring,pid,centstring);
      char epsname_pos_cb[100];
      sprintf(epsname_pos_cb,"RatioFigures/STAR_ppg054_published_%s_pos_%d_dis_cent%s.eps",sectorstring,pid,centstring);
      ...
      tmg_neg_cb->GetXaxis()->SetLimits(0.0,7.0);
      ...
      TPaveText *pave_neg_cb = new TPaveText(1.01, 0.1, 2.5, 0.4, "br");
      ...
      TLegend *leg_neg_cb = new TLegend(0.18,0.68,0.48,0.88);
      leg_neg_cb->SetFillColor(kWhite);
      leg_neg_cb->SetBorderSize(0);
      leg_neg_cb->AddEntry(tge_negcb,"#pi^{-}, Run7/PPG026","p");
      leg_neg_cb->AddEntry(tge2_negcb,"#pi^{-}, Run7/PPG054","p");
      leg_neg_cb->AddEntry(tge_starnegcb,"#pi^{-}, Run7/STAR","p");
      leg_neg_cb->Draw();
      
      char gifname_neg_cb[100];
      sprintf(gifname_neg_cb,"RatioFigures/STAR_ppg054_published_%s_neg_%d_dis_cent%s.gif",sectorstring,pid,centstring);
      char epsname_neg_cb[100];
      sprintf(epsname_neg_cb,"RatioFigures/STAR_ppg054_published_%s_neg_%d_dis_cent%s.eps",sectorstring,pid,centstring);
