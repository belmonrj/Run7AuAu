...
void doit(int sector=0, int pid=0, int centid=0)
{
  ...
  leg_pos_cb->AddEntry(tge_poscb,"#pi^{+}, Run8/Run3","p");
  leg_pos_cb->AddEntry(tge2_poscb,"#pi^{+}, Run8/Run3","p");
  leg_pos_cb->Draw();
  ...
  leg_neg_cb->AddEntry(tge_negcb,"#pi^{-}, Run8/Run3","p");
  leg_neg_cb->AddEntry(tge2_negcb,"#pi^{-}, Run8/Run3","p");
  leg_neg_cb->Draw();
