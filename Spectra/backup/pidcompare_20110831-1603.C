...
void doit(int sector=0, int partid=0, int centid=0)
{
  ...
  //char gifname_pos_cb[100];
  sprintf(gifname_pos_cb,"RatioFigures/pidcompare_published_pi0_%s_pos_%d_dis_cent%s.gif",sectorstring,pid,centstring);
  //char epsname_pos_cb[100];
  sprintf(epsname_pos_cb,"RatioFigures/pidcompare_published_pi0_%s_pos_%d_dis_cent%s.eps",sectorstring,pid,centstring);
  ...
  //char gifname_neg_cb[100];
  sprintf(gifname_neg_cb,"RatioFigures/pidcompare_published_pi0_%s_neg_%d_dis_cent%s.gif",sectorstring,pid,centstring);
  //char epsname_neg_cb[100];
  sprintf(epsname_neg_cb,"RatioFigures/pidcompare_published_pi0_%s_neg_%d_dis_cent%s.eps",sectorstring,pid,centstring);
