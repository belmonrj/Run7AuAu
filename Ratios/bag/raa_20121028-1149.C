...
void doit_file(int centid=0, int pionid=0, int kaonid=4, int protonid=6)
{
  ...
  TGraphErrors *tge_posprotonraa = new TGraphErrors(33,ptproton,posprotonraa,eptproton,eposprotonraa);
  tge_posprotonraa->SetMarkerColor(kRed);
  tge_posprotonraa->SetMarkerStyle(kOpenSquare);
  TGraphErrors *tge_negprotonraa = new TGraphErrors(33,ptproton,negprotonraa,eptproton,enegprotonraa);
  tge_negprotonraa->SetMarkerColor(kBlue);
  tge_negprotonraa->SetMarkerStyle(kOpenSquare);
  TGraphErrors *tge_sysposprotonraa = new TGraphErrors(33,ptproton,posprotonraa,eptproton,esysposprotonraa);
  TGraphErrors *tge_sysnegprotonraa = new TGraphErrors(33,ptproton,negprotonraa,eptproton,esysnegprotonraa);
