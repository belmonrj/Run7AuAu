...
void epsi()
{
  ...
  TH2F *hhtfwbgsdphi_pospm_pT = (TH2F *)filepm->Get("bkgrd_tofwsdphi_pT_epsi_pos_cent0");
  TH2F *hhtfwbgsdphi_negpm_pT = (TH2F *)filepm->Get("bkgrd_tofwsdphi_pT_epsi_neg_cent0");
 
  TFile *filemp = TFile::Open("outhighmp.root");
  if(!filemp) {cerr<<"Fatal Error!  Cannot open root file "<<endl; exit(1);}

  TH2F *hhtfwbgsdphi_posmp_pT = (TH2F *)filemp->Get("bkgrd_tofwsdphi_pT_epsi_pos_cent0");
  TH2F *hhtfwbgsdphi_negmp_pT = (TH2F *)filemp->Get("bkgrd_tofwsdphi_pT_epsi_neg_cent0");
  ...
  ofstream ftfwbgsdphipospmRpT("data/tfwbgsdphi_epsi_cent0_pospm_RpT.txt");
  ofstream ftfwbgsdphinegpmRpT("data/tfwbgsdphi_epsi_cent0_negpm_RpT.txt");
  ofstream ftfwbgsdphiposmpRpT("data/tfwbgsdphi_epsi_cent0_posmp_RpT.txt");
  ofstream ftfwbgsdphinegmpRpT("data/tfwbgsdphi_epsi_cent0_negmp_RpT.txt");
  ...
  for(int i=6; i<12; i++)
    {
      ...
      sprintf(title,"tfwbgsdphi, epsi, 0-10%%,  %2.1f < p_{T} < %2.1f",ptlow,pthigh);
      ...
      sprintf(total,"total");
      sprintf(epsial,"#mu=%3.2f, #sigma=%3.2f",fpospmfg->GetParameter(1),fpospmfg->GetParameter(2));
      ...
      leg->AddEntry(fpospmfg,epsial,"l");
      ...
      leg2->AddEntry(fpospmfg,epsial2,"l");
      leg2->AddEntry(fpospmbg,background2,"l");
      leg2->Draw();
      
      sprintf(figname,"figsfit/tfwbgsdphi_epsi_cent0_pospm_RpT_dis_%d.gif",i);
      c1->Print(figname);
      sprintf(figname,"figsfit/tfwbgsdphi_epsi_cent0_pospm_RpT_dis_%d.eps",i);
      c1->Print(figname);
	...
	10*fpospm->Integral(-2.0,2.0)/htfwbgsdphi_pospm_pT->Integral(31,70)<<endl;
      ...
      sprintf(total,"total");
      sprintf(epsial,"#mu=%3.2f, #sigma=%3.2f",fnegpmfg->GetParameter(1),fnegpmfg->GetParameter(2));
      ...
      leg->AddEntry(fnegpmfg,epsial,"l");
      ...
      leg2->AddEntry(fnegpmfg,epsial2,"l");
      leg2->AddEntry(fnegpmbg,background2,"l");
      leg2->Draw();
      
      sprintf(figname,"figsfit/tfwbgsdphi_epsi_cent0_negpm_RpT_dis_%d.gif",i);
      c1->Print(figname);
      sprintf(figname,"figsfit/tfwbgsdphi_epsi_cent0_negpm_RpT_dis_%d.eps",i);
      c1->Print(figname);
	...
	10*fnegpm->Integral(-2.0,2.0)/htfwbgsdphi_negpm_pT->Integral(31,70)<<endl;
      ...
      sprintf(total,"total");
      sprintf(epsial,"#mu=%3.2f, #sigma=%3.2f",fposmpfg->GetParameter(1),fposmpfg->GetParameter(2));
      ...
      leg->AddEntry(fposmpfg,epsial,"l");
      ...
      leg2->AddEntry(fposmpfg,epsial2,"l");
      leg2->AddEntry(fposmpbg,background2,"l");
      leg2->Draw();
      
      sprintf(figname,"figsfit/tfwbgsdphi_epsi_cent0_posmp_RpT_dis_%d.gif",i);
      c1->Print(figname);
      sprintf(figname,"figsfit/tfwbgsdphi_epsi_cent0_posmp_RpT_dis_%d.eps",i);
      c1->Print(figname);
	...
	10*fposmp->Integral(-2.0,2.0)/htfwbgsdphi_posmp_pT->Integral(31,70)<<endl;
      ...
      sprintf(total,"total");
      sprintf(epsial,"#mu=%3.2f, #sigma=%3.2f",fnegmpfg->GetParameter(1),fnegmpfg->GetParameter(2));
      ...
      leg->AddEntry(fnegmpfg,epsial,"l");
      ...
      leg2->AddEntry(fnegmpfg,epsial2,"l");
      leg2->AddEntry(fnegmpbg,background2,"l");
      leg2->Draw();
      
      sprintf(figname,"figsfit/tfwbgsdphi_epsi_cent0_negmp_RpT_dis_%d.gif",i);
      c1->Print(figname);
      sprintf(figname,"figsfit/tfwbgsdphi_epsi_cent0_negmp_RpT_dis_%d.eps",i);
      c1->Print(figname);
