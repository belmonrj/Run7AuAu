...
void fore()
{
  ...
  TH2F *hhtfwbgsdphi_pospm_pT = (TH2F *)filepm->Get("bkgrd_tofwsdphi_pT_fore_pos_cent4");
  TH2F *hhtfwbgsdphi_negpm_pT = (TH2F *)filepm->Get("bkgrd_tofwsdphi_pT_fore_neg_cent4");
 
  TFile *filemp = TFile::Open("outhighmp.root");
  if(!filemp) {cerr<<"Fatal Error!  Cannot open root file "<<endl; exit(1);}

  TH2F *hhtfwbgsdphi_posmp_pT = (TH2F *)filemp->Get("bkgrd_tofwsdphi_pT_fore_pos_cent4");
  TH2F *hhtfwbgsdphi_negmp_pT = (TH2F *)filemp->Get("bkgrd_tofwsdphi_pT_fore_neg_cent4");
  ...
  ifstream finpospmRpT("data/tfwbgsdphi_back_cent4_pospm_RpT.txt");
  ifstream finnegpmRpT("data/tfwbgsdphi_back_cent4_negpm_RpT.txt");
  ifstream finposmpRpT("data/tfwbgsdphi_back_cent4_posmp_RpT.txt");
  ifstream finnegmpRpT("data/tfwbgsdphi_back_cent4_negmp_RpT.txt");

  ofstream ftfwbgsdphipospmRpT("data/tfwbgsdphi_fore_cent4_pospm_RpT.txt");
  ofstream ftfwbgsdphinegpmRpT("data/tfwbgsdphi_fore_cent4_negpm_RpT.txt");
  ofstream ftfwbgsdphiposmpRpT("data/tfwbgsdphi_fore_cent4_posmp_RpT.txt");
  ofstream ftfwbgsdphinegmpRpT("data/tfwbgsdphi_fore_cent4_negmp_RpT.txt");
  ...
  for(int i=6; i<12; i++)
    {
      ...
      sprintf(title,"tfwbgsdphi, fore, 0-10%%,  %2.1f < p_{T} < %2.1f",ptlow,pthigh);
      ...
      sprintf(figname,"figsfit/tfwbgsdphi_fore_cent4_pospm_RpT_dis_%d.gif",i);
      c1->Print(figname);
      sprintf(figname,"figsfit/tfwbgsdphi_fore_cent4_pospm_RpT_dis_%d.eps",i);
      c1->Print(figname);
	...
	10*fpospm->Integral(-2.0,2.0)/htfwbgsdphi_pospm_pT->Integral(31,70)<<endl;
      ...
      sprintf(figname,"figsfit/tfwbgsdphi_fore_cent4_negpm_RpT_dis_%d.gif",i);
      c1->Print(figname);
      sprintf(figname,"figsfit/tfwbgsdphi_fore_cent4_negpm_RpT_dis_%d.eps",i);
      c1->Print(figname);
	...
	10*fnegpm->Integral(-2.0,2.0)/htfwbgsdphi_negpm_pT->Integral(31,70)<<endl;
      ...
      sprintf(figname,"figsfit/tfwbgsdphi_fore_cent4_posmp_RpT_dis_%d.gif",i);
      c1->Print(figname);
      sprintf(figname,"figsfit/tfwbgsdphi_fore_cent4_posmp_RpT_dis_%d.eps",i);
      c1->Print(figname);
	...
	10*fposmp->Integral(-2.0,2.0)/htfwbgsdphi_posmp_pT->Integral(31,70)<<endl;
      ...
      sprintf(figname,"figsfit/tfwbgsdphi_fore_cent4_negmp_RpT_dis_%d.gif",i);
      c1->Print(figname);
      sprintf(figname,"figsfit/tfwbgsdphi_fore_cent4_negmp_RpT_dis_%d.eps",i);
      c1->Print(figname);
