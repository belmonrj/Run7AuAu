...
void pion()
{
  ...
  TH2F *hhtfwbgsdphi_pospm_pT = (TH2F *)filepm->Get("bkgrd_tofwsdphi_pT_back_pos_cent4");
  TH2F *hhtfwbgsdphi_negpm_pT = (TH2F *)filepm->Get("bkgrd_tofwsdphi_pT_back_neg_cent4");
 
  TFile *filemp = TFile::Open("outhighmp.root");
  if(!filemp) {cerr<<"Fatal Error!  Cannot open root file "<<endl; exit(1);}

  TH2F *hhtfwbgsdphi_posmp_pT = (TH2F *)filemp->Get("bkgrd_tofwsdphi_pT_back_pos_cent4");
  TH2F *hhtfwbgsdphi_negmp_pT = (TH2F *)filemp->Get("bkgrd_tofwsdphi_pT_back_neg_cent4");
  ...
  ofstream ftfwbgsdphipospmRpT("data/tfwbgsdphi_back_cent4_pospm_RpT.txt");
  ofstream ftfwbgsdphinegpmRpT("data/tfwbgsdphi_back_cent4_negpm_RpT.txt");
  ofstream ftfwbgsdphiposmpRpT("data/tfwbgsdphi_back_cent4_posmp_RpT.txt");
  ofstream ftfwbgsdphinegmpRpT("data/tfwbgsdphi_back_cent4_negmp_RpT.txt");
  ...
  for(int i=6; i<12; i++)
    {
      ...
      sprintf(figname,"figsfit/tfwbgsdphi_back_cent4_pospm_RpT_dis_%d.gif",i);
      c1->Print(figname);
      sprintf(figname,"figsfit/tfwbgsdphi_back_cent4_pospm_RpT_dis_%d.eps",i);
      c1->Print(figname);
      ...
      sprintf(figname,"figsfit/tfwbgsdphi_back_cent4_negpm_RpT_dis_%d.gif",i);
      c1->Print(figname);
      sprintf(figname,"figsfit/tfwbgsdphi_back_cent4_negpm_RpT_dis_%d.eps",i);
      c1->Print(figname);
      ...
      sprintf(figname,"figsfit/tfwbgsdphi_back_cent4_posmp_RpT_dis_%d.gif",i);
      c1->Print(figname);
      sprintf(figname,"figsfit/tfwbgsdphi_back_cent4_posmp_RpT_dis_%d.eps",i);
      c1->Print(figname);
      ...
      sprintf(figname,"figsfit/tfwbgsdphi_back_cent4_negmp_RpT_dis_%d.gif",i);
      c1->Print(figname);
      sprintf(figname,"figsfit/tfwbgsdphi_back_cent4_negmp_RpT_dis_%d.eps",i);
      c1->Print(figname);
