      ...
      for(int i=0;i<n;i++) // loop over events
	{
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      if(regular_cuts&&edge&&inner)
		{
	      ...
	      bool dis0 = piondis3;
	      bool dis1 = piondis4;
	      bool dis2 = (pT>=5.0)?(dis0&&good_emc&&ep>0.2):dis0;
	      bool dis3 = (pT>=3.0)?(dis0&&good_emc&&ep>0.2):dis0;
	      bool dis4 = kaondis3;
	      bool dis5 = kaondis3 && tfw_HM && pc3_HM;
	      bool dis6 = protondis3;
	      bool dis7 = protondis4;
	      bool dis8 = (pT>=5.0)?(dis6&&good_emc&&ep>0.2):dis6;
	      bool dis9 = (pT>=3.0)?(dis6&&good_emc&&ep>0.2):dis6;
...
float isPionANA_v3(float x, float m2tofw)
{
  ...
  float par0 = 0.896; // angular resolution
  float par1 = 0.992; // multiple scattering term
  float par2 = 0.095; // timing resolution
