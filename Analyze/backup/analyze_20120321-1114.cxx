      ...
      for(int i=0;i<n;i++) // loop over events
	{
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      if(regular_cuts&&edge&&inner)
		{
	      ...
	      // bool dis1 = dis0;// && good_emc && ep>0.2;
	      // if(pT>=3.0) dis1 = dis0 && good_emc && ep>0.2;
	      // bool dis2 = isPiANA>=-2 && isPiANA<=2 && isKANA<=-2;
	      // bool dis3 = isPiLME>=-2 && isPiLME<=2;
	      // //kaons
	      ...
	      // bool dis7 = dis6;// && good_emc && ep>0.2;
	      // if(pT>=3.0) dis7 = dis6 && good_emc && ep>0.2;
	      // bool dis8 = isPANA>=-2 && isPANA<=2 && isKANA>=2;
	      // bool dis9 = isPLME>=-2 && isPLME<=2;
