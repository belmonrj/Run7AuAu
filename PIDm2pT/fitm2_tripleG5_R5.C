void fitm2_tripleG5_R5()
{
  ...
  for(int INDEX=6; INDEX<12; INDEX++)
      ...
      if(i>=50&&i<60)
	{
      ...
      funkaonA->Draw("same");
      funprotA->Draw("same");
      sprintf(pionfigname,"m2pT_figs/m2pT_both_tripleG_method5R5_%d.gif",i);
      c1->Print(pionfigname);
      sprintf(pionfigname,"m2pT_figs/m2pT_both_tripleG_method5R5_%d.eps",i);
      c1->Print(pionfigname);
