  ...
  for(int INDEX=6; INDEX<7; INDEX++)
    {
      ...
      superfun->SetParameter(0,2.9e4);
      superfun->SetParameter(1,0.015);
      superfun->SetParameter(2,0.1);
      superfun->SetParameter(3,1.3e4);
      superfun->SetParameter(4,0.24);
      superfun->SetParameter(5,0.12);
      superfun->SetParameter(6,1.315e4);
      superfun->SetParameter(7,0.905);
      superfun->SetParameter(8,0.135);
      ...
      //superfun->SetParLimits(3,0.15*max,max);//upper limit arbitrary
      ...
      //superfun->SetParLimits(7,0.9,0.92);
      ...
      funkaonA->Draw("same");
      funprotA->Draw("same");
      sprintf(pionfigname,"m2pT_figs/m2pT_both_tripleG_method6R5_%d.gif",i);
      c1->Print(pionfigname);
      sprintf(pionfigname,"m2pT_figs/m2pT_both_tripleG_method6R5_%d.eps",i);
      c1->Print(pionfigname);
