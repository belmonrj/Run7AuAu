...
void step1(int ipid=0, int itype=0, int iswitch=0, int centid=0)
{
  ...
  sprintf(name_real_tofw_pos_pm,"ptpid_tofw_pos_%d_dis",pidnumber);
  sprintf(name_sim_tofw_pos_pm,"ptpid_tofw_pos_%d_dis",pidnumber);
  sprintf(name_real_tofw_neg_pm,"ptpid_tofw_neg_%d_dis",pidnumber);
  sprintf(name_sim_tofw_neg_pm,"ptpid_tofw_neg_%d_dis",pidnumber);

  sprintf(name_real_tofw_pos_mp,"ptpid_tofw_pos_%d_dis",pidnumber);
  sprintf(name_sim_tofw_pos_mp,"ptpid_tofw_pos_%d_dis",pidnumber);
  sprintf(name_real_tofw_neg_mp,"ptpid_tofw_neg_%d_dis",pidnumber);
