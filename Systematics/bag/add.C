...
void doit(int ipid=0, int centid=0)
{
  ...
  char fignameA[100];
  sprintf(fignameA,"Added/sys_uncert_pos_%s_sumA_%s.png",pidstring,centstring);
  c1->Print(fignameA);
  sprintf(fignameA,"Added/sys_uncert_pos_%s_sumA_%s.eps",pidstring,centstring);
  c1->Print(fignameA);
  ...
  char fignameB[100];
  sprintf(fignameB,"Added/sys_uncert_pos_%s_sumB_%s.png",pidstring,centstring);
  c1->Print(fignameB);
  sprintf(fignameB,"Added/sys_uncert_pos_%s_sumB_%s.eps",pidstring,centstring);
  c1->Print(fignameB);
  ...
  char fignameAa[100];
  sprintf(fignameAa,"Added/sys_uncert_pos_%s_sumAa_%s.png",pidstring,centstring);
  c1->Print(fignameAa);
  sprintf(fignameAa,"Added/sys_uncert_pos_%s_sumAa_%s.eps",pidstring,centstring);
  c1->Print(fignameAa);
  ...
  char fignameBb[100];
  sprintf(fignameBb,"Added/sys_uncert_pos_%s_sumBb_%s.png",pidstring,centstring);
  c1->Print(fignameBb);
  sprintf(fignameBb,"Added/sys_uncert_pos_%s_sumBb_%s.eps",pidstring,centstring);
  c1->Print(fignameBb);
  ...
  char fignameA[100];
  sprintf(fignameA,"Added/sys_uncert_neg_%s_sumA_%s.png",pidstring,centstring);
  c1->Print(fignameA);
  sprintf(fignameA,"Added/sys_uncert_neg_%s_sumA_%s.eps",pidstring,centstring);
  c1->Print(fignameA);
  ...
  char fignameB[100];
  sprintf(fignameB,"Added/sys_uncert_neg_%s_sumB_%s.png",pidstring,centstring);
  c1->Print(fignameB);
  sprintf(fignameB,"Added/sys_uncert_neg_%s_sumB_%s.eps",pidstring,centstring);
  c1->Print(fignameB);
  ...
  char fignameAa[100];
  sprintf(fignameAa,"Added/sys_uncert_neg_%s_sumAa_%s.png",pidstring,centstring);
  c1->Print(fignameAa);
  sprintf(fignameAa,"Added/sys_uncert_neg_%s_sumAa_%s.eps",pidstring,centstring);
  c1->Print(fignameAa);
  ...
  char fignameBb[100];
  sprintf(fignameBb,"Added/sys_uncert_neg_%s_sumBb_%s.png",pidstring,centstring);
  c1->Print(fignameBb);
  sprintf(fignameBb,"Added/sys_uncert_neg_%s_sumBb_%s.eps",pidstring,centstring);
  c1->Print(fignameBb);
