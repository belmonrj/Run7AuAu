...
void doit(int ipid=0, int itype=0, int iswitch=0, int centid=0)
{
  ...
  sprintf(gifname,"Figures/single_spectra_%s_pos_%s%s_%s.gif",pidstring,typestring,switchstring,centstring);
  sprintf(epsname,"Figures/single_spectra_%s_pos_%s%s_%s.eps",pidstring,typestring,switchstring,centstring);
  c1->Print(gifname);
  c1->Print(epsname);
  ...
  sprintf(gifname,"Figures/single_spectra_%s_neg_%s%s_%s.gif",pidstring,typestring,switchstring,centstring);
  sprintf(epsname,"Figures/single_spectra_%s_neg_%s%s_%s.eps",pidstring,typestring,switchstring,centstring);
  c1->Print(gifname);
  c1->Print(epsname);
  ...
  sprintf(gifname,"Figures/single_ratio_%s_pos_%s%s_%s.gif",pidstring,typestring,switchstring,centstring);
  sprintf(epsname,"Figures/single_ratio_%s_pos_%s%s_%s.eps",pidstring,typestring,switchstring,centstring);
  c1->Print(gifname);
  c1->Print(epsname);
  ...
  sprintf(gifname,"Figures/single_suncert_%s_pos_%s%s_%s.gif",pidstring,typestring,switchstring,centstring);
  sprintf(epsname,"Figures/single_suncert_%s_pos_%s%s_%s.eps",pidstring,typestring,switchstring,centstring);
  c1->Print(gifname);
  c1->Print(epsname);
  ...
  sprintf(gifname,"Figures/single_ratio_%s_neg_%s%s_%s.gif",pidstring,typestring,switchstring,centstring);
  sprintf(epsname,"Figures/single_ratio_%s_neg_%s%s_%s.eps",pidstring,typestring,switchstring,centstring);
  c1->Print(gifname);
  c1->Print(epsname);
  ...
  sprintf(gifname,"Figures/single_suncert_%s_neg_%s%s_%s.gif",pidstring,typestring,switchstring,centstring);
  sprintf(epsname,"Figures/single_suncert_%s_neg_%s%s_%s.eps",pidstring,typestring,switchstring,centstring);
  c1->Print(gifname);
  c1->Print(epsname);
