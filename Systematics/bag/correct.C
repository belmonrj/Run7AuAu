...
void doit(int ipid=0, int itype=0, int iswitch=0, int centid=0)
{
  ...
  sprintf(name_real_tofw_pos_pm,"ptsys_%s_pos_%s%s%s",pidstring,typestring,switchstring,centstring);
  sprintf(name_sim_tofw_pos_pm,"ptsys_%s_pos_%s%s",pidstring,typestring,switchstring);
  sprintf(name_real_tofw_neg_pm,"ptsys_%s_neg_%s%s%s",pidstring,typestring,switchstring,centstring);
  sprintf(name_sim_tofw_neg_pm,"ptsys_%s_neg_%s%s",pidstring,typestring,switchstring);

  sprintf(name_real_tofw_pos_mp,"ptsys_%s_pos_%s%s%s",pidstring,typestring,switchstring,centstring);
  sprintf(name_sim_tofw_pos_mp,"ptsys_%s_pos_%s%s",pidstring,typestring,switchstring);
  sprintf(name_real_tofw_neg_mp,"ptsys_%s_neg_%s%s%s",pidstring,typestring,switchstring,centstring);
