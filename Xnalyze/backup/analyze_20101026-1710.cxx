  ...
  if(zed>0)
    {
      ...
      //if(alpha>slope*phi-slope*-0.021&&phi>-0.105&&phi<-0.089) return false;
      if(alpha>slope*phi-slope*-0.021&&phi>-0.058&&phi<-0.052) return false;
      if(alpha>slope*phi-slope*-0.021&&phi>-0.039&&phi<-0.032) return false;
      //if(alpha>slope*phi-slope*-0.021&&phi>-0.021&&phi<-0.013) return false;
      if(alpha>slope*phi-slope*-0.021&&phi>0.047&&phi<0.555) return false; // experimental
      //if(alpha>slope*phi-slope*-0.021&&phi>0.047&&phi<0.055) return false; // previous
      //if(alpha>slope*phi-slope*-0.021&&phi>0.062&&phi<0.068) return false; // previous

      if(alpha<slope*phi-slope*-0.014&&phi>0.020&&phi<0.025) return false;
      if(alpha<slope*phi-slope*-0.014&&phi>0.039&&phi<0.046) return false;
      //if(alpha<slope*phi-slope*-0.014&&phi>0.055&&phi<0.065) return false;
      if(alpha<slope*phi-slope*-0.014&&phi>0.056&&phi<0.066) return false;
      //if(alpha<slope*phi-slope*-0.014&&phi>0.075&&phi<0.085) return false;
      if(alpha<slope*phi-slope*-0.014&&phi>0.077&&phi<0.087) return false;
      //if(alpha<slope*phi-slope*-0.014&&phi>0.095&&phi<0.105) return false;
      if(alpha<slope*phi-slope*-0.014&&phi>0.099&&phi<0.109) return false;
      //if(alpha<slope*phi-slope*-0.014&&phi>0.115&&phi<0.125) return false;
      if(alpha<slope*phi-slope*-0.014&&phi>0.119&&phi<0.128) return false;
      if(alpha<slope*phi-slope*-0.014&&phi>0.135&&phi<0.185) return false; // experimental
      //if(alpha<slope*phi-slope*-0.014&&phi>0.135&&phi<0.145) return false; // previous
  ...
  if(zed<0)
    {
      ...
      if(alpha>slope*phi-slope*-0.021&&phi>-0.039&&phi<-0.032) return false;
      if(alpha>slope*phi-slope*-0.021&&phi>-0.021&&phi<-0.013) return false;
      if(alpha>slope*phi-slope*-0.021&&phi>0.047&&phi<0.555) return false;
      //if(alpha>slope*phi-slope*-0.021&&phi>0.047&&phi<0.055) return false;
      //if(alpha>slope*phi-slope*-0.021&&phi>0.062&&phi<0.068) return false;
