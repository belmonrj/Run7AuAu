  ...
  if(zed>0)
    {
      ...
      if(alpha>slope*phi-slope*-0.014 && phi>0.047 && phi<0.054) return false; // NEW

      if(phi>-0.223&&phi<-0.184) return false; // NEW
      ...
      //if(phi>0.095&&phi<0.105) return false; // new
      //if(phi>0.115&&phi<0.125) return false; // new
      //if(phi>0.135&&phi<0.145) return false; // new
      if(phi>0.145&&phi<0.200) return false; // new

      if(alpha<slope*phi-slope*-0.021)
	{
      ...
      //if(alpha<slope*phi-slope*0.494&&phi>0.475&&phi<0.488) return false; // new // south only
      ...
      if(phi>0.635&&phi<0.700) return false; // cut the corner
  ...
  if(zed<0)
    {
      ...
      //if(phi>-0.223&&phi<-0.184) return false; // NEW // not needed on south side because of giant hole
      ...
      //if(alpha>slope*phi-slope*-0.014 && alpha<sline*phi-sline*0.062 && alpha>sline*phi-sline*0.072) return false; // new and a little silly, but for testing purposes

      if(alpha<slope*phi-slope*-0.021)
	{
	  if(alpha<sline*phi-sline*0.032 && alpha>sline*phi-sline*0.042) return false;
	  if(alpha<sline*phi-sline*0.052 && alpha>sline*phi-sline*0.062) return false;
	  //if(alpha<sline*phi-sline*0.062 && alpha>sline*phi-sline*0.072) return false; // new and a little silly, but for testing purposes
	  if(alpha<sline*phi-sline*0.072 && alpha>sline*phi-sline*0.082) return false;
	  if(alpha<sline*phi-sline*0.092 && alpha>sline*phi-sline*0.102) return false;
	  if(alpha<sline*phi-sline*0.112 && alpha>sline*phi-sline*0.122) return false;
	  if(alpha<sline*phi-sline*0.132 && alpha>sline*phi-sline*0.142) return false;
