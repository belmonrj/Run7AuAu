      ...
      for(int i=0;i<n;i++) // loop over events
	{
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      if(regular_cuts&&edge&&inner)
		{
	      ...
	      bool dis1 = isPiLow>=-2 && isPiLow<=2 && isKLow<=-2 && ep>0.10 && good_emc;
	      bool dis2 = isPiLow>=-2 && isPiLow<=2 && isKLow<=-2 && ep>0.15 && good_emc;
	      bool dis3 = isPiLow>=-2 && isPiLow<=2 && isKLow<=-2 && ep>0.20 && good_emc;
	      //kaons
	      bool dis4 = isKLow>=-2 && isKLow<=2 && isPiLow>=2 && isPLow<=-2;
	      bool dis5 = isKNew>=-2 && isKNew<=2 && isPiNew>=2 && isPNew<=-2;
	      // protons
	      bool dis6 = isPLow>=-2 && isPLow<=2 && isKLow>=2 && good_emc;
	      bool dis7 = isPLow>=-2 && isPLow<=2 && isKLow>=2 && ep>0.10 && good_emc;
	      bool dis8 = isPLow>=-2 && isPLow<=2 && isKLow>=2 && ep>0.15 && good_emc;
	      bool dis9 = isPLow>=-2 && isPLow<=2 && isKLow>=2 && ep>0.20 && good_emc;
