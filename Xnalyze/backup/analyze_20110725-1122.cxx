	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      if(syst_tfwmatch)
		{
		  if(charge>0)
			...
			{
			  if(dis3) {bkgrd_tofwsdz_pT_pion_pos->Fill(pT,tofwsdz);}
			  if(dis4) {bkgrd_tofwsdz_pT_kaon_pos->Fill(pT,tofwsdz);}
			  if(dis9) {bkgrd_tofwsdz_pT_prot_pos->Fill(pT,tofwsdz);}
			  if(icent==0)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_pos_cent0->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_pos_cent0->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_pos_cent0->Fill(pT,tofwsdz);}
			    }
			  if(icent==1)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_pos_cent1->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_pos_cent1->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_pos_cent1->Fill(pT,tofwsdz);}
			    }
			  if(icent==2)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_pos_cent2->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_pos_cent2->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_pos_cent2->Fill(pT,tofwsdz);}
			    }
			  if(icent==3)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_pos_cent3->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_pos_cent3->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_pos_cent3->Fill(pT,tofwsdz);}
			    }
			  if(icent==4)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_pos_cent4->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_pos_cent4->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_pos_cent4->Fill(pT,tofwsdz);}
			    }
			  if(icent==5)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_pos_cent5->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_pos_cent5->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_pos_cent5->Fill(pT,tofwsdz);}
			    }
			  if(icent==6)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_pos_cent6->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_pos_cent6->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_pos_cent6->Fill(pT,tofwsdz);}
			    }
			  if(icent==7)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_pos_cent7->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_pos_cent7->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_pos_cent7->Fill(pT,tofwsdz);}
			    }
			  if(icent==8)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_pos_cent8->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_pos_cent8->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_pos_cent8->Fill(pT,tofwsdz);}
			    }
			}		  
		      if(fabs(tofwsdz)<2.0)
			{
			  if(dis3) {bkgrd_tofwsdphi_pT_pion_pos->Fill(pT,tofwsdz);}
			  if(dis4) {bkgrd_tofwsdphi_pT_kaon_pos->Fill(pT,tofwsdz);}
			  if(dis9) {bkgrd_tofwsdphi_pT_prot_pos->Fill(pT,tofwsdz);}
			  if(icent==0)
			    {
		  ...
		  if(charge<0)
		    {
		      if(fabs(tofwsdphi)<2.0)
			{
			  if(dis3) {bkgrd_tofwsdz_pT_pion_neg->Fill(pT,tofwsdz);}
			  if(dis4) {bkgrd_tofwsdz_pT_kaon_neg->Fill(pT,tofwsdz);}
			  if(dis9) {bkgrd_tofwsdz_pT_prot_neg->Fill(pT,tofwsdz);}
			  if(icent==0)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_neg_cent0->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_neg_cent0->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_neg_cent0->Fill(pT,tofwsdz);}
			    }
			  if(icent==1)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_neg_cent1->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_neg_cent1->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_neg_cent1->Fill(pT,tofwsdz);}
			    }
			  if(icent==2)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_neg_cent2->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_neg_cent2->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_neg_cent2->Fill(pT,tofwsdz);}
			    }
			  if(icent==3)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_neg_cent3->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_neg_cent3->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_neg_cent3->Fill(pT,tofwsdz);}
			    }
			  if(icent==4)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_neg_cent4->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_neg_cent4->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_neg_cent4->Fill(pT,tofwsdz);}
			    }
			  if(icent==5)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_neg_cent5->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_neg_cent5->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_neg_cent5->Fill(pT,tofwsdz);}
			    }
			  if(icent==6)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_neg_cent6->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_neg_cent6->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_neg_cent6->Fill(pT,tofwsdz);}
			    }
			  if(icent==7)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_neg_cent7->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_neg_cent7->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_neg_cent7->Fill(pT,tofwsdz);}
			    }
			  if(icent==8)
			    {
			      if(dis3) {bkgrd_tofwsdz_pT_pion_neg_cent8->Fill(pT,tofwsdz);}
			      if(dis4) {bkgrd_tofwsdz_pT_kaon_neg_cent8->Fill(pT,tofwsdz);}
			      if(dis9) {bkgrd_tofwsdz_pT_prot_neg_cent8->Fill(pT,tofwsdz);}
			    }
			}		  
		      if(fabs(tofwsdz)<2.0)
			{
			  if(dis3) {bkgrd_tofwsdphi_pT_pion_neg->Fill(pT,tofwsdz);}
			  if(dis4) {bkgrd_tofwsdphi_pT_kaon_neg->Fill(pT,tofwsdz);}
			  if(dis9) {bkgrd_tofwsdphi_pT_prot_neg->Fill(pT,tofwsdz);}
			  if(icent==0)
			    {
