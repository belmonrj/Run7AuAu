...
{ 
  ...
  TH2F *DeltaTPi_dis_pos = new TH2F("DeltaTPi_dis_pos","DeltaTPi vs mom", 100, 0, 10, 100, -2.0, 2.0);
  TH2F *DeltaTPi_dis_neg = new TH2F("DeltaTPi_dis_neg","DeltaTPi vs mom", 100, 0, 10, 100, -2.0, 2.0);
  TH2F *DeltaTK_dis_pos = new TH2F("DeltaTK_dis_pos","DeltaTK vs mom", 100, 0, 10, 100, -2.0, 2.0);
  TH2F *DeltaTK_dis_neg = new TH2F("DeltaTK_dis_neg","DeltaTK vs mom", 100, 0, 10, 100, -2.0, 2.0);
  TH2F *DeltaTP_dis_pos = new TH2F("DeltaTP_dis_pos","DeltaTP vs mom", 100, 0, 10, 100, -2.0, 2.0);
  TH2F *DeltaTP_dis_neg = new TH2F("DeltaTP_dis_neg","DeltaTP vs mom", 100, 0, 10, 100, -2.0, 2.0);
