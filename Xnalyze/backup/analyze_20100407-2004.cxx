...
{ 
  ...
  // no cuts
  TH2F *hhh_alphaphi_0 = new TH2F("hhh_alphaphi_0","alpha vs phi _0", 400, -0.2, 0.2, 200, -0.1, 0.1);
  TH2F *hhh_pos_phipt_0 = new TH2F("hhh_pos_phipt_0","phi vs pT _0", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_pos_momphi_0 = new TH2F("hhh_pos_momphi_0","mom vs phi _0", 400, -0.2, 0.2, 100, 0, 10);
  TH2F *hhh_neg_phipt_0 = new TH2F("hhh_neg_phipt_0","phi vs pT _0", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_neg_momphi_0 = new TH2F("hhh_neg_momphi_0","mom vs phi _0", 400, -0.2, 0.2, 100, 0, 10);
  // zed cuts
  TH2F *hhh_alphaphi_1 = new TH2F("hhh_alphaphi_1","alpha vs phi _1", 400, -0.2, 0.2, 200, -0.1, 0.1);
  TH2F *hhh_pos_phipt_1 = new TH2F("hhh_pos_phipt_1","phi vs pT _1", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_pos_momphi_1 = new TH2F("hhh_pos_momphi_1","mom vs phi _1", 400, -0.2, 0.2, 100, 0, 10);
  TH2F *hhh_neg_phipt_1 = new TH2F("hhh_neg_phipt_1","phi vs pT _1", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_neg_momphi_1 = new TH2F("hhh_neg_momphi_1","mom vs phi _1", 400, -0.2, 0.2, 100, 0, 10);
  // quality cuts
  TH2F *hhh_alphaphi_2 = new TH2F("hhh_alphaphi_2","alpha vs phi _2", 400, -0.2, 0.2, 200, -0.1, 0.1);
  TH2F *hhh_pos_phipt_2 = new TH2F("hhh_pos_phipt_2","phi vs pT _2", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_pos_momphi_2 = new TH2F("hhh_pos_momphi_2","mom vs phi _2", 400, -0.2, 0.2, 100, 0, 10);
  TH2F *hhh_neg_phipt_2 = new TH2F("hhh_neg_phipt_2","phi vs pT _2", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_neg_momphi_2 = new TH2F("hhh_neg_momphi_2","mom vs phi _2", 400, -0.2, 0.2, 100, 0, 10);
  // pc1 fiducial cuts
  TH2F *hhh_alphaphi_3 = new TH2F("hhh_alphaphi_3","alpha vs phi _3", 400, -0.2, 0.2, 200, -0.1, 0.1);
  TH2F *hhh_pos_phipt_3 = new TH2F("hhh_pos_phipt_3","phi vs pT _3", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_pos_momphi_3 = new TH2F("hhh_pos_momphi_3","mom vs phi _3", 400, -0.2, 0.2, 100, 0, 10);
  TH2F *hhh_neg_phipt_3 = new TH2F("hhh_neg_phipt_3","phi vs pT _3", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_neg_momphi_3 = new TH2F("hhh_neg_momphi_3","mom vs phi _3", 400, -0.2, 0.2, 100, 0, 10);
  // pc3 fiducial cuts
  TH2F *hhh_alphaphi_4 = new TH2F("hhh_alphaphi_4","alpha vs phi _4", 400, -0.2, 0.2, 200, -0.1, 0.1);
  TH2F *hhh_pos_phipt_4 = new TH2F("hhh_pos_phipt_4","phi vs pT _4", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_pos_momphi_4 = new TH2F("hhh_pos_momphi_4","mom vs phi _4", 400, -0.2, 0.2, 100, 0, 10);
  TH2F *hhh_neg_phipt_4 = new TH2F("hhh_neg_phipt_4","phi vs pT _4", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_neg_momphi_4 = new TH2F("hhh_neg_momphi_4","mom vs phi _4", 400, -0.2, 0.2, 100, 0, 10);
  // pc3 matching
  TH2F *hhh_alphaphi_5 = new TH2F("hhh_alphaphi_5","alpha vs phi _5", 400, -0.2, 0.2, 200, -0.1, 0.1);
  TH2F *hhh_pos_phipt_5 = new TH2F("hhh_pos_phipt_5","phi vs pT _5", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_pos_momphi_5 = new TH2F("hhh_pos_momphi_5","mom vs phi _5", 400, -0.2, 0.2, 100, 0, 10);
  TH2F *hhh_neg_phipt_5 = new TH2F("hhh_neg_phipt_5","phi vs pT _5", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_neg_momphi_5 = new TH2F("hhh_neg_momphi_5","mom vs phi _5", 400, -0.2, 0.2, 100, 0, 10);
  // tofw matching
  TH2F *hhh_alphaphi_6 = new TH2F("hhh_alphaphi_6","alpha vs phi _6", 400, -0.2, 0.2, 200, -0.1, 0.1);
  TH2F *hhh_pos_phipt_6 = new TH2F("hhh_pos_phipt_6","phi vs pT _6", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_pos_momphi_6 = new TH2F("hhh_pos_momphi_6","mom vs phi _6", 400, -0.2, 0.2, 100, 0, 10);
  TH2F *hhh_neg_phipt_6 = new TH2F("hhh_neg_phipt_6","phi vs pT _6", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_neg_momphi_6 = new TH2F("hhh_neg_momphi_6","mom vs phi _6", 400, -0.2, 0.2, 100, 0, 10);
  // tofw edge cut
  TH2F *hhh_alphaphi_7 = new TH2F("hhh_alphaphi_7","alpha vs phi _7", 400, -0.2, 0.2, 200, -0.1, 0.1);
  TH2F *hhh_pos_phipt_7 = new TH2F("hhh_pos_phipt_7","phi vs pT _7", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_pos_momphi_7 = new TH2F("hhh_pos_momphi_7","mom vs phi _7", 400, -0.2, 0.2, 100, 0, 10);
  TH2F *hhh_neg_phipt_7 = new TH2F("hhh_neg_phipt_7","phi vs pT _7", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_neg_momphi_7 = new TH2F("hhh_neg_momphi_7","mom vs phi _7", 400, -0.2, 0.2, 100, 0, 10);
  // tofw strip cut
  TH2F *hhh_alphaphi_8 = new TH2F("hhh_alphaphi_8","alpha vs phi _8", 400, -0.2, 0.2, 200, -0.1, 0.1);
  TH2F *hhh_pos_phipt_8 = new TH2F("hhh_pos_phipt_8","phi vs pT _8", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_pos_momphi_8 = new TH2F("hhh_pos_momphi_8","mom vs phi _8", 400, -0.2, 0.2, 100, 0, 10);
  TH2F *hhh_neg_phipt_8 = new TH2F("hhh_neg_phipt_8","phi vs pT _8", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_neg_momphi_8 = new TH2F("hhh_neg_momphi_8","mom vs phi _8", 400, -0.2, 0.2, 100, 0, 10);
  // all cuts (because why not?)
  TH2F *hhh_alphaphi_9 = new TH2F("hhh_alphaphi_9","alpha vs phi _9", 400, -0.2, 0.2, 200, -0.1, 0.1);
  TH2F *hhh_pos_phipt_9 = new TH2F("hhh_pos_phipt_9","phi vs pT _9", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_pos_momphi_9 = new TH2F("hhh_pos_momphi_9","mom vs phi _9", 400, -0.2, 0.2, 100, 0, 10);
  TH2F *hhh_neg_phipt_9 = new TH2F("hhh_neg_phipt_9","phi vs pT _9", 100, 0, 10, 400, -0.2, 0.2);
  TH2F *hhh_neg_momphi_9 = new TH2F("hhh_neg_momphi_9","mom vs phi _9", 400, -0.2, 0.2, 100, 0, 10);
      ...
      for(int i=0;i<n;i++) // loop over events
	{
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      else if(run>=236133&&run<=240121)
		{
	      ...
	      //if(run>=228042&&run<=235810)
	      if(run>=228042&&run<=235810&&DCHFiducial(run,alpha,zed,board))
		{ 
	      ...
	      //else if(run>=236133&&run<=240121)
	      else if(run>=236133&&run<=240121&&DCHFiducial(run,alpha,zed,board))
		{
	      ...
	      if(GoodPC1(pc1z,pc1phi)) PC1ZedPhiNewDis->Fill(pc1z,pc1phi);
	      ...
	      if(GoodPC2(pc2z,pc2phi)) PC2ZedPhiNewDis->Fill(pc2z,pc2phi);
	      ...
	      if(GoodPC3(pc3z,pc3phi)) PC3ZedPhiNewDis->Fill(pc3z,pc3phi);
	      ...
	      bool tofwedge = (fabs(tofwz)<185&&fabs(tofwz)>4)&&((tofwphi>-0.1&&tofwphi<0.06)||(tofwphi>0.41&&tofwphi<0.58));
	      if(tofwedge&&tfw_matching&&pc3_matching&&GoodPC3(pc3z,pc3phi)) TOFWZedPhiNewDis->Fill(tofwz,tofwphi);
	      //if(tofwz<-180||tofwz>180||tofwphi<-0.1||tofwphi>0.06) continue;
	      ...
	      if(goodStrip(striptofw))
		{
	      ...
	      bool goodtrack = (good_dc&&GoodPC1(pc1z,pc1phi)&&GoodPC3(pc3z,pc3phi)&&good_adc&&tofwedge&&pc3_matching&&tfw_matching&&goodStrip(striptofw));
	      ...
	      if(goodtrack&&isPi)
		{
	      ...
	      hhh_alphaphi_0->Fill(phi,alpha);
	      if(charge>0) hhh_pos_phipt_0->Fill(pT,phi);
	      if(charge<0) hhh_neg_phipt_0->Fill(pT,phi);
	      if(charge>0) hhh_pos_momphi_0->Fill(phi,mom);
	      if(charge<0) hhh_neg_momphi_0->Fill(phi,mom);

	      if(!(fabs(zed)<70||fabs(zed)>3)) continue;
	      hhh_alphaphi_1->Fill(phi,alpha);
	      if(charge>0) hhh_pos_phipt_1->Fill(pT,phi);
	      if(charge<0) hhh_neg_phipt_1->Fill(pT,phi);
	      if(charge>0) hhh_pos_momphi_1->Fill(phi,mom);
	      if(charge<0) hhh_neg_momphi_1->Fill(phi,mom);
	      
	      //if(!(quality==63||quality==31)) continue;
	      if(quality<29) continue;
	      hhh_alphaphi_2->Fill(phi,alpha);
	      if(charge>0) hhh_pos_phipt_2->Fill(pT,phi);
	      if(charge<0) hhh_neg_phipt_2->Fill(pT,phi);
	      if(charge>0) hhh_pos_momphi_2->Fill(phi,mom);
	      if(charge<0) hhh_neg_momphi_2->Fill(phi,mom);

	      if(!GoodPC1(pc1z,pc1phi)) continue;
	      hhh_alphaphi_3->Fill(phi,alpha);
	      if(charge>0) hhh_pos_phipt_3->Fill(pT,phi);
	      if(charge<0) hhh_neg_phipt_3->Fill(pT,phi);
	      if(charge>0) hhh_pos_momphi_3->Fill(phi,mom);
	      if(charge<0) hhh_neg_momphi_3->Fill(phi,mom);

	      if(!GoodPC3(pc3z,pc3phi)) continue;
	      hhh_alphaphi_4->Fill(phi,alpha);
	      if(charge>0) hhh_pos_phipt_4->Fill(pT,phi);
	      if(charge<0) hhh_neg_phipt_4->Fill(pT,phi);
	      if(charge>0) hhh_pos_momphi_4->Fill(phi,mom);
	      if(charge<0) hhh_neg_momphi_4->Fill(phi,mom);

	      if(!pc3_matching) continue;
	      hhh_alphaphi_5->Fill(phi,alpha);
	      if(charge>0) hhh_pos_phipt_5->Fill(pT,phi);
	      if(charge<0) hhh_neg_phipt_5->Fill(pT,phi);
	      if(charge>0) hhh_pos_momphi_5->Fill(phi,mom);
	      if(charge<0) hhh_neg_momphi_5->Fill(phi,mom);

	      if(!tfw_matching) continue;
	      hhh_alphaphi_6->Fill(phi,alpha);
	      if(charge>0) hhh_pos_phipt_6->Fill(pT,phi);
	      if(charge<0) hhh_neg_phipt_6->Fill(pT,phi);
	      if(charge>0) hhh_pos_momphi_6->Fill(phi,mom);
	      if(charge<0) hhh_neg_momphi_6->Fill(phi,mom);

	      //if(!good_adc) continue;
	      if(!tofwedge) continue;
	      hhh_alphaphi_7->Fill(phi,alpha);
	      if(charge>0) hhh_pos_phipt_7->Fill(pT,phi);
	      if(charge<0) hhh_neg_phipt_7->Fill(pT,phi);
	      if(charge>0) hhh_pos_momphi_7->Fill(phi,mom);
	      if(charge<0) hhh_neg_momphi_7->Fill(phi,mom);

	      if(!goodStrip(striptofw)) continue;
	      hhh_alphaphi_8->Fill(phi,alpha);
	      if(charge>0) hhh_pos_phipt_8->Fill(pT,phi);
	      if(charge<0) hhh_neg_phipt_8->Fill(pT,phi);
	      if(charge>0) hhh_pos_momphi_8->Fill(phi,mom);
	      if(charge<0) hhh_neg_momphi_8->Fill(phi,mom);

	      if(!isPi) continue;
	      hhh_alphaphi_9->Fill(phi,alpha);
	      if(charge>0) hhh_pos_phipt_9->Fill(pT,phi);
	      if(charge<0) hhh_neg_phipt_9->Fill(pT,phi);
	      if(charge>0) hhh_pos_momphi_9->Fill(phi,mom);
	      if(charge<0) hhh_neg_momphi_9->Fill(phi,mom);
