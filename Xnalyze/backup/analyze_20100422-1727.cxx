...
{ 
  ...
  TH2F *m2momdis_pos = new TH2F("m2momdis_pos","m2 vs mom", 75, 0, 7.5, 300, -1.0, 2.0);
  TH2F *m2momdis_neg = new TH2F("m2momdis_neg","m2 vs mom", 75, 0, 7.5, 300, -1.0, 2.0);
  TH2F *pc3dz_dis_pos = new TH2F("pc3dz_dis_pos","m2 vs mom", 10, 0, 5.0, 100, -5.0, 5.0);
  TH2F *pc3dz_dis_neg = new TH2F("pc3dz_dis_neg","m2 vs mom", 10, 0, 5.0, 100, -5.0, 5.0);
  TH2F *pc3dphi_dis_pos = new TH2F("pc3dphi_dis_pos","m2 vs mom", 10, 0, 5.0, 100, -5.0, 5.0);
  TH2F *pc3dphi_dis_neg = new TH2F("pc3dphi_dis_neg","m2 vs mom", 10, 0, 5.0, 100, -5.0, 5.0);
  TH2F *tofwdz_dis_pos = new TH2F("tofwdz_dis_pos","m2 vs mom", 10, 0, 5.0, 100, -5.0, 5.0);
  TH2F *tofwdz_dis_neg = new TH2F("tofwdz_dis_neg","m2 vs mom", 10, 0, 5.0, 100, -5.0, 5.0);
  TH2F *tofwdphi_dis_pos = new TH2F("tofwdphi_dis_pos","m2 vs mom", 10, 0, 5.0, 100, -5.0, 5.0);
  TH2F *tofwdphi_dis_neg = new TH2F("tofwdphi_dis_neg","m2 vs mom", 10, 0, 5.0, 100, -5.0, 5.0);
