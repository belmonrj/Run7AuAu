      ...
      for(int i=0;i<n;i++) // loop over events
	{
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      if(regular_cuts&&edge&&inner)
		{
		  ...
		  if(cent>60&&cent<=29&&charge<0) isPi_dis_neg_cent6092->Fill(pT,isPiLow);//important
	      ...
	      //kaons
	      bool dis4 = isKLow>=-2 && isKLow<=2 && isPiLow>=2 && isPLow<=-2;
	      bool dis5 = isKLow>=-2 && isKLow<=2 && isPiLow>=2 && isPLow<=-2 && ep>0.2;
	      // protons
	      bool dis6 = isPLow>=-2 && isPLow<=2 && isKLow>=2;
	      bool dis7 = isPLow>=-2 && isPLow<=2 && isKLow>=2 && ep>0.2;
	      bool dis8 = isPLow>=-2 && isPLow<=2;
	      bool dis9 = isPLow>=-2 && isPLow<=2 && ep>0.2;
