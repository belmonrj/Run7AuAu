  ...
  if(zed>0)
    {
      ...
      cutg->SetPoint(0,-0.013,0.002);
      cutg->SetPoint(1,0.024,0.002);
      cutg->SetPoint(2,0.024,0.067);
      cutg->SetPoint(3,-0.013,0.002);
      if(cutg->IsInside(phi,alpha)) return false;
      TCutG *cutg2 = new TCutG("CUTG2",4);
      cutg2->SetPoint(0,-0.059,-0.001);
      cutg2->SetPoint(1,-0.023,-0.001);
      cutg2->SetPoint(2,-0.059,-0.063);
      cutg2->SetPoint(3,-0.059,-0.001);
