      ...
      for(int i=0;i<n;i++) // loop over events
	{
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      if(regular_cuts&&edge&&inner)
		{
	      ...
	      bool sysgoodemc = SysGoodEMC(emcz,emcphi);
	      ...
	      // pions
	      bool dis0 = isPiLow>=-2 && isPiLow<=2 && isKLow<=-2;
	      //if(pT>3) dis0 &= (ep>0.2 && good_emc);
	      bool dis1 = isPiLow>=-2 && isPiLow<=2 && isKLow<=-2 && good_emc;
	      bool dis2 = isPiLow>=-2 && isPiLow<=2 && isKLow<=-2 && ep>0.2 && good_emc;
	      bool dis3 = isPiLow>=-2 && isPiLow<=2 && isKLow<=-2 && ep>0.2;
	      //kaons
	      //bool dis4 = isKLow>=-2 && isKLow<=2 && isPiLow>=2 && isPLow<=-2;
	      bool dis4 = isKNew>=-2 && isKNew<=2 && isPiNew>=2 && isPNew<=-2;
	      bool dis5 = isKNew>=-2 && isKNew<=2 && isPiNew>=2 && isPNew<=-2 && ep>0.2 && good_emc;
	      //bool dis5 = isKLow>=-2 && isKLow<=2;
	      // protons
	      bool dis6 = isPLow>=-2 && isPLow<=2 && isKLow>=2;
	      //if(pT>4) dis6 &= (ep>0.2 && good_emc);
	      bool dis7 = isPLow>=-2 && isPLow<=2 && isKLow>=2 && good_emc;
	      bool dis8 = isPLow>=-2 && isPLow<=2 && isKLow>=2 && ep>0.2 && good_emc;
	      bool dis9 = isPLow>=-2 && isPLow<=2 && isKLow>=2 && ep>0.2;
