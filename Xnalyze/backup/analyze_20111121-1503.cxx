...
{ 
  ...
  TH1F *hh_X_spectpt_pospion_cent6 = new TH1F("hh_X_spectpt_pospion_cent6", "...", 100, 0.0, 10.0);
  TH1F *hh_X_spectpt_negpion_cent6 = new TH1F("hh_X_spectpt_negpion_cent6", "...", 100, 0.0, 10.0);
  TH1F *hh_X_spectpt_posproton_cent6 = new TH1F("hh_X_spectpt_posproton_cent6", "...", 100, 0.0, 10.0);
  TH1F *hh_X_spectpt_negproton_cent6 = new TH1F("hh_X_spectpt_negproton_cent6", "...", 100, 0.0, 10.0);
  ...
  TH1F *hh_X_specept_pospion_cent6 = new TH1F("hh_X_specept_pospion_cent6", "...", 100, 0.0, 10.0);
  TH1F *hh_X_specept_negpion_cent6 = new TH1F("hh_X_specept_negpion_cent6", "...", 100, 0.0, 10.0);
  TH1F *hh_X_specept_posproton_cent6 = new TH1F("hh_X_specept_posproton_cent6", "...", 100, 0.0, 10.0);
  TH1F *hh_X_specept_negproton_cent6 = new TH1F("hh_X_specept_negproton_cent6", "...", 100, 0.0, 10.0);
      ...
      for(int i=0;i<n;i++) // loop over events
	{
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      if(regular_cuts&&edge&&inner&&zed<0)
		{
	      ...
	      //isPiLow /= 0.85; // SUPER TEMP
	      //isPiNew /= 0.85; // SUPER TEMP
	      ...
	      if(regular_cuts&&edge&&inner)
		{
	      ...
	      // pions
	      bool dis0 = isPiLow>=-2 && isPiLow<=2 && isKLow<=-2 && good_emc;
	      bool dis1 = isPiNew>=-2 && isPiNew<=2 && isKNew<=-2 && good_emc;
	      bool dis2 = isPiLow>=-2 && isPiLow<=2 && isKLow<=-2 && ep>0.20 && good_emc;
	      bool dis3 = isPiNew>=-2 && isPiNew<=2 && isKNew<=-2 && ep>0.20 && good_emc;
	      //kaons
	      bool dis4 = isKLow>=-2 && isKLow<=2 && isPiLow>=2 && isPLow<=-2;
	      bool dis5 = isKNew>=-2 && isKNew<=2 && isPiNew>=2 && isPNew<=-2;
	      // protons
	      bool dis6 = isPLow>=-2 && isPLow<=2 && isKLow>=2 && good_emc;
	      bool dis7 = isPNew>=-2 && isPNew<=2 && isKNew>=2 && good_emc;
	      bool dis8 = isPLow>=-2 && isPLow<=2 && isKLow>=2 && ep>0.20 && good_emc;
	      bool dis9 = isPNew>=-2 && isPNew<=2 && isKNew>=2 && ep>0.20 && good_emc;
	      ...
	      if(cent>60&&charge>0&&dis0) hh_X_spectpt_pospion_cent6->Fill(pT);
	      if(cent>60&&charge<0&&dis0) hh_X_spectpt_negpion_cent6->Fill(pT);
	      if(cent>60&&charge>0&&dis6) hh_X_spectpt_posproton_cent6->Fill(pT);
	      if(cent>60&&charge<0&&dis6) hh_X_spectpt_negproton_cent6->Fill(pT);
	      if(cent>60&&charge>0&&dis0&&ecore/pT>0.2) hh_X_specept_pospion_cent6->Fill(pT);
	      if(cent>60&&charge<0&&dis0&&ecore/pT>0.2) hh_X_specept_negpion_cent6->Fill(pT);
	      if(cent>60&&charge>0&&dis6&&ecore/pT>0.2) hh_X_specept_posproton_cent6->Fill(pT);
	      if(cent>60&&charge<0&&dis6&&ecore/pT>0.2) hh_X_specept_negproton_cent6->Fill(pT);
