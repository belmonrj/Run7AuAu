...
{ 
  ...
  TH1F *before_tofw_w1_pos_0_dis = new TH1F("before_tofw_w1_pos_0_dis", "tofw w1 0 pos pion sigma #in [-2,2]", 80, 0, 8.0);
  TH1F *before_tofw_w1_pos_1_dis = new TH1F("before_tofw_w1_pos_1_dis", "tofw w1 1 pos pion sigma #in [-2,0]", 80, 0, 8.0);
  TH1F *before_tofw_w1_pos_2_dis = new TH1F("before_tofw_w1_pos_2_dis", "tofw w1 2 pos pion sigma #in [-2,2] && !K", 80, 0, 8.0);
  TH1F *before_tofw_w1_pos_3_dis = new TH1F("before_tofw_w1_pos_3_dis", "tofw w1 3 pos pion sigma #in [-2,0] && !K", 80, 0, 8.0);
  TH1F *before_tofw_w1_pos_4_dis = new TH1F("before_tofw_w1_pos_4_dis", "tofw w1 4 pos kaon sigma #in [-2,2]", 80, 0, 8.0);
  TH1F *before_tofw_w1_pos_5_dis = new TH1F("before_tofw_w1_pos_5_dis", "tofw w1 5 pos kaon sigma #in [-2,2] && !#pi && !p", 80, 0, 8.0);
  TH1F *before_tofw_w1_pos_6_dis = new TH1F("before_tofw_w1_pos_6_dis", "tofw w1 6 pos proton sigma #in [-2,2]", 80, 0, 8.0);
  TH1F *before_tofw_w1_pos_7_dis = new TH1F("before_tofw_w1_pos_7_dis", "tofw w1 7 pos proton sigma #in [0,2]", 80, 0, 8.0);
  TH1F *before_tofw_w1_pos_8_dis = new TH1F("before_tofw_w1_pos_8_dis", "tofw w1 8 pos proton sigma #in [-2,2] && !K", 80, 0, 8.0);
  TH1F *before_tofw_w1_pos_9_dis = new TH1F("before_tofw_w1_pos_9_dis", "tofw w1 9 pos proton sigma #in [0,2] && !K", 80, 0, 8.0);

  TH1F *before_tofw_w1_neg_0_dis = new TH1F("before_tofw_w1_neg_0_dis", "tofw w1 0 neg pion sigma #in [-2,2]", 80, 0, 8.0);
  TH1F *before_tofw_w1_neg_1_dis = new TH1F("before_tofw_w1_neg_1_dis", "tofw w1 1 neg pion sigma #in [-2,0]", 80, 0, 8.0);
  TH1F *before_tofw_w1_neg_2_dis = new TH1F("before_tofw_w1_neg_2_dis", "tofw w1 2 neg pion sigma #in [-2,2] && !K", 80, 0, 8.0);
  TH1F *before_tofw_w1_neg_3_dis = new TH1F("before_tofw_w1_neg_3_dis", "tofw w1 3 neg pion sigma #in [-2,0] && !K", 80, 0, 8.0);
  TH1F *before_tofw_w1_neg_4_dis = new TH1F("before_tofw_w1_neg_4_dis", "tofw w1 4 neg kaon sigma #in [-2,2]", 80, 0, 8.0);
  TH1F *before_tofw_w1_neg_5_dis = new TH1F("before_tofw_w1_neg_5_dis", "tofw w1 5 neg kaon sigma #in [-2,2] && !#pi && !p", 80, 0, 8.0);
  TH1F *before_tofw_w1_neg_6_dis = new TH1F("before_tofw_w1_neg_6_dis", "tofw w1 6 neg proton sigma #in [-2,2]", 80, 0, 8.0);
  TH1F *before_tofw_w1_neg_7_dis = new TH1F("before_tofw_w1_neg_7_dis", "tofw w1 7 neg proton sigma #in [0,2]", 80, 0, 8.0);
  TH1F *before_tofw_w1_neg_8_dis = new TH1F("before_tofw_w1_neg_8_dis", "tofw w1 8 neg proton sigma #in [-2,2] && !K", 80, 0, 8.0);
  TH1F *before_tofw_w1_neg_9_dis = new TH1F("before_tofw_w1_neg_9_dis", "tofw w1 9 neg proton sigma #in [0,2] && !K", 80, 0, 8.0);

  TH1F *before_tofw_w2_pos_0_dis = new TH1F("before_tofw_w2_pos_0_dis", "tofw w2 0 pos pion sigma #in [-2,2]", 80, 0, 8.0);
  TH1F *before_tofw_w2_pos_1_dis = new TH1F("before_tofw_w2_pos_1_dis", "tofw w2 1 pos pion sigma #in [-2,0]", 80, 0, 8.0);
  TH1F *before_tofw_w2_pos_2_dis = new TH1F("before_tofw_w2_pos_2_dis", "tofw w2 2 pos pion sigma #in [-2,2] && !K", 80, 0, 8.0);
  TH1F *before_tofw_w2_pos_3_dis = new TH1F("before_tofw_w2_pos_3_dis", "tofw w2 3 pos pion sigma #in [-2,0] && !K", 80, 0, 8.0);
  TH1F *before_tofw_w2_pos_4_dis = new TH1F("before_tofw_w2_pos_4_dis", "tofw w2 4 pos kaon sigma #in [-2,2]", 80, 0, 8.0);
  TH1F *before_tofw_w2_pos_5_dis = new TH1F("before_tofw_w2_pos_5_dis", "tofw w2 5 pos kaon sigma #in [-2,2] && !#pi && !p", 80, 0, 8.0);
  TH1F *before_tofw_w2_pos_6_dis = new TH1F("before_tofw_w2_pos_6_dis", "tofw w2 6 pos proton sigma #in [-2,2]", 80, 0, 8.0);
  TH1F *before_tofw_w2_pos_7_dis = new TH1F("before_tofw_w2_pos_7_dis", "tofw w2 7 pos proton sigma #in [0,2]", 80, 0, 8.0);
  TH1F *before_tofw_w2_pos_8_dis = new TH1F("before_tofw_w2_pos_8_dis", "tofw w2 8 pos proton sigma #in [-2,2] && !K", 80, 0, 8.0);
  TH1F *before_tofw_w2_pos_9_dis = new TH1F("before_tofw_w2_pos_9_dis", "tofw w2 9 pos proton sigma #in [0,2] && !K", 80, 0, 8.0);

  TH1F *before_tofw_w2_neg_0_dis = new TH1F("before_tofw_w2_neg_0_dis", "tofw w2 0 neg pion sigma #in [-2,2]", 80, 0, 8.0);
  TH1F *before_tofw_w2_neg_1_dis = new TH1F("before_tofw_w2_neg_1_dis", "tofw w2 1 neg pion sigma #in [-2,0]", 80, 0, 8.0);
  TH1F *before_tofw_w2_neg_2_dis = new TH1F("before_tofw_w2_neg_2_dis", "tofw w2 2 neg pion sigma #in [-2,2] && !K", 80, 0, 8.0);
  TH1F *before_tofw_w2_neg_3_dis = new TH1F("before_tofw_w2_neg_3_dis", "tofw w2 3 neg pion sigma #in [-2,0] && !K", 80, 0, 8.0);
  TH1F *before_tofw_w2_neg_4_dis = new TH1F("before_tofw_w2_neg_4_dis", "tofw w2 4 neg kaon sigma #in [-2,2]", 80, 0, 8.0);
  TH1F *before_tofw_w2_neg_5_dis = new TH1F("before_tofw_w2_neg_5_dis", "tofw w2 5 neg kaon sigma #in [-2,2] && !#pi && !p", 80, 0, 8.0);
  TH1F *before_tofw_w2_neg_6_dis = new TH1F("before_tofw_w2_neg_6_dis", "tofw w2 6 neg proton sigma #in [-2,2]", 80, 0, 8.0);
  TH1F *before_tofw_w2_neg_7_dis = new TH1F("before_tofw_w2_neg_7_dis", "tofw w2 7 neg proton sigma #in [0,2]", 80, 0, 8.0);
  TH1F *before_tofw_w2_neg_8_dis = new TH1F("before_tofw_w2_neg_8_dis", "tofw w2 8 neg proton sigma #in [-2,2] && !K", 80, 0, 8.0);
  TH1F *before_tofw_w2_neg_9_dis = new TH1F("before_tofw_w2_neg_9_dis", "tofw w2 9 neg proton sigma #in [0,2] && !K", 80, 0, 8.0);
  ...
  TH1F *before_tofw_w1_pos_0_dis_cent[10];
  TH1F *before_tofw_w1_pos_1_dis_cent[10];
  TH1F *before_tofw_w1_pos_2_dis_cent[10];
  TH1F *before_tofw_w1_pos_3_dis_cent[10];
  TH1F *before_tofw_w1_pos_4_dis_cent[10];
  TH1F *before_tofw_w1_pos_5_dis_cent[10];
  TH1F *before_tofw_w1_pos_6_dis_cent[10];
  TH1F *before_tofw_w1_pos_7_dis_cent[10];
  TH1F *before_tofw_w1_pos_8_dis_cent[10];
  TH1F *before_tofw_w1_pos_9_dis_cent[10];

  TH1F *before_tofw_w1_neg_0_dis_cent[10];
  TH1F *before_tofw_w1_neg_1_dis_cent[10];
  TH1F *before_tofw_w1_neg_2_dis_cent[10];
  TH1F *before_tofw_w1_neg_3_dis_cent[10];
  TH1F *before_tofw_w1_neg_4_dis_cent[10];
  TH1F *before_tofw_w1_neg_5_dis_cent[10];
  TH1F *before_tofw_w1_neg_6_dis_cent[10];
  TH1F *before_tofw_w1_neg_7_dis_cent[10];
  TH1F *before_tofw_w1_neg_8_dis_cent[10];
  TH1F *before_tofw_w1_neg_9_dis_cent[10];

  char name_before_tofw_w1_pos_0_dis_cent[30];
  char name_before_tofw_w1_pos_1_dis_cent[30];
  char name_before_tofw_w1_pos_2_dis_cent[30];
  char name_before_tofw_w1_pos_3_dis_cent[30];
  char name_before_tofw_w1_pos_4_dis_cent[30];
  char name_before_tofw_w1_pos_5_dis_cent[30];
  char name_before_tofw_w1_pos_6_dis_cent[30];
  char name_before_tofw_w1_pos_7_dis_cent[30];
  char name_before_tofw_w1_pos_8_dis_cent[30];
  char name_before_tofw_w1_pos_9_dis_cent[30];

  char name_before_tofw_w1_neg_0_dis_cent[30];
  char name_before_tofw_w1_neg_1_dis_cent[30];
  char name_before_tofw_w1_neg_2_dis_cent[30];
  char name_before_tofw_w1_neg_3_dis_cent[30];
  char name_before_tofw_w1_neg_4_dis_cent[30];
  char name_before_tofw_w1_neg_5_dis_cent[30];
  char name_before_tofw_w1_neg_6_dis_cent[30];
  char name_before_tofw_w1_neg_7_dis_cent[30];
  char name_before_tofw_w1_neg_8_dis_cent[30];
  char name_before_tofw_w1_neg_9_dis_cent[30];

  for(int i=0; i<9; i++)
    {
      sprintf(name_before_tofw_w1_pos_0_dis_cent,"before_tofw_w1_pos_0_dis_cent_%d",i);
      before_tofw_w1_pos_0_dis_cent[i] = new TH1F(name_before_tofw_w1_pos_0_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_pos_1_dis_cent,"before_tofw_w1_pos_1_dis_cent_%d",i);
      before_tofw_w1_pos_1_dis_cent[i] = new TH1F(name_before_tofw_w1_pos_1_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_pos_2_dis_cent,"before_tofw_w1_pos_2_dis_cent_%d",i);
      before_tofw_w1_pos_2_dis_cent[i] = new TH1F(name_before_tofw_w1_pos_2_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_pos_3_dis_cent,"before_tofw_w1_pos_3_dis_cent_%d",i);
      before_tofw_w1_pos_3_dis_cent[i] = new TH1F(name_before_tofw_w1_pos_3_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_pos_4_dis_cent,"before_tofw_w1_pos_4_dis_cent_%d",i);
      before_tofw_w1_pos_4_dis_cent[i] = new TH1F(name_before_tofw_w1_pos_4_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_pos_5_dis_cent,"before_tofw_w1_pos_5_dis_cent_%d",i);
      before_tofw_w1_pos_5_dis_cent[i] = new TH1F(name_before_tofw_w1_pos_5_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_pos_6_dis_cent,"before_tofw_w1_pos_6_dis_cent_%d",i);
      before_tofw_w1_pos_6_dis_cent[i] = new TH1F(name_before_tofw_w1_pos_6_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_pos_7_dis_cent,"before_tofw_w1_pos_7_dis_cent_%d",i);
      before_tofw_w1_pos_7_dis_cent[i] = new TH1F(name_before_tofw_w1_pos_7_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_pos_8_dis_cent,"before_tofw_w1_pos_8_dis_cent_%d",i);
      before_tofw_w1_pos_8_dis_cent[i] = new TH1F(name_before_tofw_w1_pos_8_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_pos_9_dis_cent,"before_tofw_w1_pos_9_dis_cent_%d",i);
      before_tofw_w1_pos_9_dis_cent[i] = new TH1F(name_before_tofw_w1_pos_9_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_neg_0_dis_cent,"before_tofw_w1_neg_0_dis_cent_%d",i);
      before_tofw_w1_neg_0_dis_cent[i] = new TH1F(name_before_tofw_w1_neg_0_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_neg_1_dis_cent,"before_tofw_w1_neg_1_dis_cent_%d",i);
      before_tofw_w1_neg_1_dis_cent[i] = new TH1F(name_before_tofw_w1_neg_1_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_neg_2_dis_cent,"before_tofw_w1_neg_2_dis_cent_%d",i);
      before_tofw_w1_neg_2_dis_cent[i] = new TH1F(name_before_tofw_w1_neg_2_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_neg_3_dis_cent,"before_tofw_w1_neg_3_dis_cent_%d",i);
      before_tofw_w1_neg_3_dis_cent[i] = new TH1F(name_before_tofw_w1_neg_3_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_neg_4_dis_cent,"before_tofw_w1_neg_4_dis_cent_%d",i);
      before_tofw_w1_neg_4_dis_cent[i] = new TH1F(name_before_tofw_w1_neg_4_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_neg_5_dis_cent,"before_tofw_w1_neg_5_dis_cent_%d",i);
      before_tofw_w1_neg_5_dis_cent[i] = new TH1F(name_before_tofw_w1_neg_5_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_neg_6_dis_cent,"before_tofw_w1_neg_6_dis_cent_%d",i);
      before_tofw_w1_neg_6_dis_cent[i] = new TH1F(name_before_tofw_w1_neg_6_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_neg_7_dis_cent,"before_tofw_w1_neg_7_dis_cent_%d",i);
      before_tofw_w1_neg_7_dis_cent[i] = new TH1F(name_before_tofw_w1_neg_7_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_neg_8_dis_cent,"before_tofw_w1_neg_8_dis_cent_%d",i);
      before_tofw_w1_neg_8_dis_cent[i] = new TH1F(name_before_tofw_w1_neg_8_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w1_neg_9_dis_cent,"before_tofw_w1_neg_9_dis_cent_%d",i);
      before_tofw_w1_neg_9_dis_cent[i] = new TH1F(name_before_tofw_w1_neg_9_dis_cent, "...", 80, 0, 8.0);
    }

  // --- tofw w2 --- //

  TH1F *before_tofw_w2_pos_0_dis_cent[10];
  TH1F *before_tofw_w2_pos_1_dis_cent[10];
  TH1F *before_tofw_w2_pos_2_dis_cent[10];
  TH1F *before_tofw_w2_pos_3_dis_cent[10];
  TH1F *before_tofw_w2_pos_4_dis_cent[10];
  TH1F *before_tofw_w2_pos_5_dis_cent[10];
  TH1F *before_tofw_w2_pos_6_dis_cent[10];
  TH1F *before_tofw_w2_pos_7_dis_cent[10];
  TH1F *before_tofw_w2_pos_8_dis_cent[10];
  TH1F *before_tofw_w2_pos_9_dis_cent[10];

  TH1F *before_tofw_w2_neg_0_dis_cent[10];
  TH1F *before_tofw_w2_neg_1_dis_cent[10];
  TH1F *before_tofw_w2_neg_2_dis_cent[10];
  TH1F *before_tofw_w2_neg_3_dis_cent[10];
  TH1F *before_tofw_w2_neg_4_dis_cent[10];
  TH1F *before_tofw_w2_neg_5_dis_cent[10];
  TH1F *before_tofw_w2_neg_6_dis_cent[10];
  TH1F *before_tofw_w2_neg_7_dis_cent[10];
  TH1F *before_tofw_w2_neg_8_dis_cent[10];
  TH1F *before_tofw_w2_neg_9_dis_cent[10];

  char name_before_tofw_w2_pos_0_dis_cent[30];
  char name_before_tofw_w2_pos_1_dis_cent[30];
  char name_before_tofw_w2_pos_2_dis_cent[30];
  char name_before_tofw_w2_pos_3_dis_cent[30];
  char name_before_tofw_w2_pos_4_dis_cent[30];
  char name_before_tofw_w2_pos_5_dis_cent[30];
  char name_before_tofw_w2_pos_6_dis_cent[30];
  char name_before_tofw_w2_pos_7_dis_cent[30];
  char name_before_tofw_w2_pos_8_dis_cent[30];
  char name_before_tofw_w2_pos_9_dis_cent[30];

  char name_before_tofw_w2_neg_0_dis_cent[30];
  char name_before_tofw_w2_neg_1_dis_cent[30];
  char name_before_tofw_w2_neg_2_dis_cent[30];
  char name_before_tofw_w2_neg_3_dis_cent[30];
  char name_before_tofw_w2_neg_4_dis_cent[30];
  char name_before_tofw_w2_neg_5_dis_cent[30];
  char name_before_tofw_w2_neg_6_dis_cent[30];
  char name_before_tofw_w2_neg_7_dis_cent[30];
  char name_before_tofw_w2_neg_8_dis_cent[30];
  char name_before_tofw_w2_neg_9_dis_cent[30];

  for(int i=0; i<9; i++)
    {
      sprintf(name_before_tofw_w2_pos_0_dis_cent,"before_tofw_w2_pos_0_dis_cent_%d",i);
      before_tofw_w2_pos_0_dis_cent[i] = new TH1F(name_before_tofw_w2_pos_0_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_pos_1_dis_cent,"before_tofw_w2_pos_1_dis_cent_%d",i);
      before_tofw_w2_pos_1_dis_cent[i] = new TH1F(name_before_tofw_w2_pos_1_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_pos_2_dis_cent,"before_tofw_w2_pos_2_dis_cent_%d",i);
      before_tofw_w2_pos_2_dis_cent[i] = new TH1F(name_before_tofw_w2_pos_2_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_pos_3_dis_cent,"before_tofw_w2_pos_3_dis_cent_%d",i);
      before_tofw_w2_pos_3_dis_cent[i] = new TH1F(name_before_tofw_w2_pos_3_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_pos_4_dis_cent,"before_tofw_w2_pos_4_dis_cent_%d",i);
      before_tofw_w2_pos_4_dis_cent[i] = new TH1F(name_before_tofw_w2_pos_4_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_pos_5_dis_cent,"before_tofw_w2_pos_5_dis_cent_%d",i);
      before_tofw_w2_pos_5_dis_cent[i] = new TH1F(name_before_tofw_w2_pos_5_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_pos_6_dis_cent,"before_tofw_w2_pos_6_dis_cent_%d",i);
      before_tofw_w2_pos_6_dis_cent[i] = new TH1F(name_before_tofw_w2_pos_6_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_pos_7_dis_cent,"before_tofw_w2_pos_7_dis_cent_%d",i);
      before_tofw_w2_pos_7_dis_cent[i] = new TH1F(name_before_tofw_w2_pos_7_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_pos_8_dis_cent,"before_tofw_w2_pos_8_dis_cent_%d",i);
      before_tofw_w2_pos_8_dis_cent[i] = new TH1F(name_before_tofw_w2_pos_8_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_pos_9_dis_cent,"before_tofw_w2_pos_9_dis_cent_%d",i);
      before_tofw_w2_pos_9_dis_cent[i] = new TH1F(name_before_tofw_w2_pos_9_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_neg_0_dis_cent,"before_tofw_w2_neg_0_dis_cent_%d",i);
      before_tofw_w2_neg_0_dis_cent[i] = new TH1F(name_before_tofw_w2_neg_0_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_neg_1_dis_cent,"before_tofw_w2_neg_1_dis_cent_%d",i);
      before_tofw_w2_neg_1_dis_cent[i] = new TH1F(name_before_tofw_w2_neg_1_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_neg_2_dis_cent,"before_tofw_w2_neg_2_dis_cent_%d",i);
      before_tofw_w2_neg_2_dis_cent[i] = new TH1F(name_before_tofw_w2_neg_2_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_neg_3_dis_cent,"before_tofw_w2_neg_3_dis_cent_%d",i);
      before_tofw_w2_neg_3_dis_cent[i] = new TH1F(name_before_tofw_w2_neg_3_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_neg_4_dis_cent,"before_tofw_w2_neg_4_dis_cent_%d",i);
      before_tofw_w2_neg_4_dis_cent[i] = new TH1F(name_before_tofw_w2_neg_4_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_neg_5_dis_cent,"before_tofw_w2_neg_5_dis_cent_%d",i);
      before_tofw_w2_neg_5_dis_cent[i] = new TH1F(name_before_tofw_w2_neg_5_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_neg_6_dis_cent,"before_tofw_w2_neg_6_dis_cent_%d",i);
      before_tofw_w2_neg_6_dis_cent[i] = new TH1F(name_before_tofw_w2_neg_6_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_neg_7_dis_cent,"before_tofw_w2_neg_7_dis_cent_%d",i);
      before_tofw_w2_neg_7_dis_cent[i] = new TH1F(name_before_tofw_w2_neg_7_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_neg_8_dis_cent,"before_tofw_w2_neg_8_dis_cent_%d",i);
      before_tofw_w2_neg_8_dis_cent[i] = new TH1F(name_before_tofw_w2_neg_8_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_before_tofw_w2_neg_9_dis_cent,"before_tofw_w2_neg_9_dis_cent_%d",i);
      before_tofw_w2_neg_9_dis_cent[i] = new TH1F(name_before_tofw_w2_neg_9_dis_cent, "...", 80, 0, 8.0);
    }
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      if(striptofw>=0&&striptofw<=255)
		{
		  if(charge>0)
			...
			{
			  before_tofw_w1_pos_0_dis->Fill(pT);
			  before_tofw_w1_pos_0_dis_cent[icent]->Fill(pT);
			}
		      if(isPiNew>=-2.0&&isPiNew<=0.0)
			{
			  before_tofw_w1_pos_1_dis->Fill(pT);
			  before_tofw_w1_pos_1_dis_cent[icent]->Fill(pT);
			}
		      if(isPiNew>=-2.0&&isPiNew<=2.0&&!isK)
			{
			  before_tofw_w1_pos_2_dis->Fill(pT);
			  before_tofw_w1_pos_2_dis_cent[icent]->Fill(pT);
			}
		      if(isPiNew>=-2.0&&isPiNew<=0.0&&!isK)
			{
			  before_tofw_w1_pos_3_dis->Fill(pT);
			  before_tofw_w1_pos_3_dis_cent[icent]->Fill(pT);
			}
		      if(isKNew>=-2.0&&isKNew<=2.0)
			{
			  before_tofw_w1_pos_4_dis->Fill(pT);
			  before_tofw_w1_pos_4_dis_cent[icent]->Fill(pT);
			}
		      if(isKNew>=-2.0&&isKNew<=2.0&&!isPi&&!isP)
			{
			  before_tofw_w1_pos_5_dis->Fill(pT);
			  before_tofw_w1_pos_5_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=-2.0&&isPNew<=2.0)
			{
			  before_tofw_w1_pos_6_dis->Fill(pT);
			  before_tofw_w1_pos_6_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=0.0&&isPNew<=2.0)
			{
			  before_tofw_w1_pos_7_dis->Fill(pT);
			  before_tofw_w1_pos_7_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=-2.0&&isPNew<=2.0&&!isK)
			{
			  before_tofw_w1_pos_8_dis->Fill(pT);
			  before_tofw_w1_pos_8_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=0.0&&isPNew<=2.0&&!isK)
			{
			  before_tofw_w1_pos_9_dis->Fill(pT);
			  before_tofw_w1_pos_9_dis_cent[icent]->Fill(pT);
			}
		    } // end pos
		  if(charge<0)
		    {
		      if(isPiNew>=-2.0&&isPiNew<=2.0)
			{
			  before_tofw_w1_neg_0_dis->Fill(pT);
			  before_tofw_w1_neg_0_dis_cent[icent]->Fill(pT);
			}
		      if(isPiNew>=-2.0&&isPiNew<=0.0)
			{
			  before_tofw_w1_neg_1_dis->Fill(pT);
			  before_tofw_w1_neg_1_dis_cent[icent]->Fill(pT);
			}
		      if(isPiNew>=-2.0&&isPiNew<=2.0&&!isK)
			{
			  before_tofw_w1_neg_2_dis->Fill(pT);
			  before_tofw_w1_neg_2_dis_cent[icent]->Fill(pT);
			}
		      if(isPiNew>=-2.0&&isPiNew<=0.0&&!isK)
			{
			  before_tofw_w1_neg_3_dis->Fill(pT);
			  before_tofw_w1_neg_3_dis_cent[icent]->Fill(pT);
			}
		      if(isKNew>=-2.0&&isKNew<=2.0)
			{
			  before_tofw_w1_neg_4_dis->Fill(pT);
			  before_tofw_w1_neg_4_dis_cent[icent]->Fill(pT);
			}
		      if(isKNew>=-2.0&&isKNew<=2.0&&!isPi&&!isP)
			{
			  before_tofw_w1_neg_5_dis->Fill(pT);
			  before_tofw_w1_neg_5_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=-2.0&&isPNew<=2.0)
			{
			  before_tofw_w1_neg_6_dis->Fill(pT);
			  before_tofw_w1_neg_6_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=0.0&&isPNew<=2.0)
			{
			  before_tofw_w1_neg_7_dis->Fill(pT);
			  before_tofw_w1_neg_7_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=-2.0&&isPNew<=2.0&&!isK)
			{
			  before_tofw_w1_neg_8_dis->Fill(pT);
			  before_tofw_w1_neg_8_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=0.0&&isPNew<=2.0&&!isK)
			{
			  before_tofw_w1_neg_9_dis->Fill(pT);
			  before_tofw_w1_neg_9_dis_cent[icent]->Fill(pT);
			}
		    } // end neg
		} // end w1
		  ...
		  if(charge>0)
		    {
		      if(isPiNew>=-2.0&&isPiNew<=2.0)
			{
			  before_tofw_w2_pos_0_dis->Fill(pT);
			  before_tofw_w2_pos_0_dis_cent[icent]->Fill(pT);
			}
		      if(isPiNew>=-2.0&&isPiNew<=0.0)
			{
			  before_tofw_w2_pos_1_dis->Fill(pT);
			  before_tofw_w2_pos_1_dis_cent[icent]->Fill(pT);
			}
		      if(isPiNew>=-2.0&&isPiNew<=2.0&&!isK)
			{
			  before_tofw_w2_pos_2_dis->Fill(pT);
			  before_tofw_w2_pos_2_dis_cent[icent]->Fill(pT);
			}
		      if(isPiNew>=-2.0&&isPiNew<=0.0&&!isK)
			{
			  before_tofw_w2_pos_3_dis->Fill(pT);
			  before_tofw_w2_pos_3_dis_cent[icent]->Fill(pT);
			}
		      if(isKNew>=-2.0&&isKNew<=2.0)
			{
			  before_tofw_w2_pos_4_dis->Fill(pT);
			  before_tofw_w2_pos_4_dis_cent[icent]->Fill(pT);
			}
		      if(isKNew>=-2.0&&isKNew<=2.0&&!isPi&&!isP)
			{
			  before_tofw_w2_pos_5_dis->Fill(pT);
			  before_tofw_w2_pos_5_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=-2.0&&isPNew<=2.0)
			{
			  before_tofw_w2_pos_6_dis->Fill(pT);
			  before_tofw_w2_pos_6_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=0.0&&isPNew<=2.0)
			{
			  before_tofw_w2_pos_7_dis->Fill(pT);
			  before_tofw_w2_pos_7_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=-2.0&&isPNew<=2.0&&!isK)
			{
			  before_tofw_w2_pos_8_dis->Fill(pT);
			  before_tofw_w2_pos_8_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=0.0&&isPNew<=2.0&&!isK)
			{
			  before_tofw_w2_pos_9_dis->Fill(pT);
			  before_tofw_w2_pos_9_dis_cent[icent]->Fill(pT);
			}
		    } // end pos
		  if(charge<0)
		    {
		      if(isPiNew>=-2.0&&isPiNew<=2.0)
			{
			  before_tofw_w2_neg_0_dis->Fill(pT);
			  before_tofw_w2_neg_0_dis_cent[icent]->Fill(pT);
			}
		      if(isPiNew>=-2.0&&isPiNew<=0.0)
			{
			  before_tofw_w2_neg_1_dis->Fill(pT);
			  before_tofw_w2_neg_1_dis_cent[icent]->Fill(pT);
			}
		      if(isPiNew>=-2.0&&isPiNew<=2.0&&!isK)
			{
			  before_tofw_w2_neg_2_dis->Fill(pT);
			  before_tofw_w2_neg_2_dis_cent[icent]->Fill(pT);
			}
		      if(isPiNew>=-2.0&&isPiNew<=0.0&&!isK)
			{
			  before_tofw_w2_neg_3_dis->Fill(pT);
			  before_tofw_w2_neg_3_dis_cent[icent]->Fill(pT);
			}
		      if(isKNew>=-2.0&&isKNew<=2.0)
			{
			  before_tofw_w2_neg_4_dis->Fill(pT);
			  before_tofw_w2_neg_4_dis_cent[icent]->Fill(pT);
			}
		      if(isKNew>=-2.0&&isKNew<=2.0&&!isPi&&!isP)
			{
			  before_tofw_w2_neg_5_dis->Fill(pT);
			  before_tofw_w2_neg_5_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=-2.0&&isPNew<=2.0)
			{
			  before_tofw_w2_neg_6_dis->Fill(pT);
			  before_tofw_w2_neg_6_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=0.0&&isPNew<=2.0)
			{
			  before_tofw_w2_neg_7_dis->Fill(pT);
			  before_tofw_w2_neg_7_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=-2.0&&isPNew<=2.0&&!isK)
			{
			  before_tofw_w2_neg_8_dis->Fill(pT);
			  before_tofw_w2_neg_8_dis_cent[icent]->Fill(pT);
			}
		      if(isPNew>=0.0&&isPNew<=2.0&&!isK)
			{
			  before_tofw_w2_neg_9_dis->Fill(pT);
			  before_tofw_w2_neg_9_dis_cent[icent]->Fill(pT);
			}
		    } // end neg
		} // end w2
  ...
  if(zed>0)
    {
      ...
      if(alpha<slope*phi-slope*-0.021 && alpha>slope*phi-slope*0.200 && alpha > 0.00) return false;
