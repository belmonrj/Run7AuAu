...
{ 
  ...
  TH2F *pc3dz_dis_pos = new TH2F("pc3dz_dis_pos","m2 vs mom", 100, 0, 10, 100, -5.0, 5.0);
  TH2F *pc3dz_dis_neg = new TH2F("pc3dz_dis_neg","m2 vs mom", 100, 0, 10, 100, -5.0, 5.0);
  TH2F *pc3dphi_dis_pos = new TH2F("pc3dphi_dis_pos","m2 vs mom", 100, 0, 10, 100, -5.0, 5.0);
  TH2F *pc3dphi_dis_neg = new TH2F("pc3dphi_dis_neg","m2 vs mom", 100, 0, 10, 100, -5.0, 5.0);
  TH2F *tofwdz_dis_pos = new TH2F("tofwdz_dis_pos","m2 vs mom", 100, 0, 10, 100, -5.0, 5.0);
  TH2F *tofwdz_dis_neg = new TH2F("tofwdz_dis_neg","m2 vs mom", 100, 0, 10, 100, -5.0, 5.0);
  TH2F *tofwdphi_dis_pos = new TH2F("tofwdphi_dis_pos","m2 vs mom", 100, 0, 10, 100, -5.0, 5.0);
  TH2F *tofwdphi_dis_neg = new TH2F("tofwdphi_dis_neg","m2 vs mom", 100, 0, 10, 100, -5.0, 5.0);
      ...
      for(int i=0;i<n;i++) // loop over events
	{
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      if(zed<0)
		{
	      ...
	      if(charge>0) m2momdis_pos->Fill(m2tofw,charge*mom);
	      if(charge<0) m2momdis_neg->Fill(m2tofw,charge*mom);
