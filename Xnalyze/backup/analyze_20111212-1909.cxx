      ...
      for(int i=0;i<n;i++) // loop over events
	{
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      if(regular_cuts&&edge&&inner) // ok
		{
	      ...
	      bool distofwpion1 = isPiLow>=-2 && isPiLow<=2 && isKLow<=-2 ;
	      bool distofwpion2 = isPiANA>=-2 && isPiANA<=2 && isKANA<=-2 ;
	      bool distofwpion3 = isPiLME>=-2 && isPiLME<=2 ;
	      bool distofwpion4 = isPiLow>=-2 && isPiLow<=2 ;
	      bool distofwpion5 = isPiANA>=-2 && isPiANA<=2 ;
	      //kaons
	      ...
	      bool distofwkaon3 = isKLME>=-2 && isKLME<=2 ;
	      bool distofwkaon4 = isKLow>=-2 && isKLow<=2 ;
	      bool distofwkaon5 = isKANA>=-2 && isKANA<=2 ;
	      // protons
	      bool distofwproton0 = isPLME>=-2 && isPLME<=2 && isKLME>=2 ;
	      bool distofwproton1 = isPLow>=-2 && isPLow<=2 && isKLow>=2 ;
	      bool distofwproton2 = isPANA>=-2 && isPANA<=2 && isKANA>=2 ;
	      bool distofwproton3 = isPLME>=-2 && isPLME<=2 ;
	      bool distofwproton4 = isPLow>=-2 && isPLow<=2 ;
	      bool distofwproton5 = isPANA>=-2 && isPANA<=2 ;
	      ...
	      bool distfec2 = ecore>(0.3+0.15*pT); //Jiangyong 
	      bool distfec3 = ecore>(0.16+0.33*pT); // Federica
	      bool distfec4 = ecore>0.5;                       
	      bool distfec5 = emce/pT>0.2;                     
	      //pions
