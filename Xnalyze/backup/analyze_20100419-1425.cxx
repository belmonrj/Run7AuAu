  ...
  if(zed>0)
    {
      ...
      if(alpha<0.000&&phi>-0.033&&alpha>1.778*phi-1.778*-0.015) return false; // triangle assoc w/ stripe 3
      if(alpha>0.000&&phi<0.024&&alpha<1.778*phi-1.778*-0.015) return false; // triangle assoc w/ stripe 3
