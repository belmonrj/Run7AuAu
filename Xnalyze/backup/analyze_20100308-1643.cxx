...
bool PC3Fiducial(float pc3z, float pc3phi);
...
Long64_t nevents = 0;
Long64_t ntracks = 0;
Long64_t ngoodaccevents = 0;
Long64_t ngoodacctracks = 0;
Long64_t ngoodtofwevents = 0;
Long64_t ngoodtofwtracks = 0;
Long64_t naccPIDtracks = 0;
Long64_t ntofwPIDtracks = 0;
Long64_t ngoodacctracks_snglevent = 0;
...
{ 
  ...
  TH1F *ptpid_tacc_pos_0_dis = new TH1F("ptpid_tacc_pos_0_dis", "tofw+acc 0 pos pion accph<5", 80, 0, 8.0);
  TH1F *ptpid_tacc_pos_1_dis = new TH1F("ptpid_tacc_pos_1_dis", "tofw+acc 1 pos pion accph>5", 80, 0, 8.0);
  TH1F *ptpid_tacc_pos_2_dis = new TH1F("ptpid_tacc_pos_2_dis", "tofw+acc 2 pos pion accph>10", 80, 0, 8.0);
  TH1F *ptpid_tacc_pos_3_dis = new TH1F("ptpid_tacc_pos_3_dis", "tofw+acc 3 pos pion accph>15", 80, 0, 8.0);
  TH1F *ptpid_tacc_pos_4_dis = new TH1F("ptpid_tacc_pos_4_dis", "tofw+acc 4 pos kaon accph<5", 80, 0, 8.0);
  TH1F *ptpid_tacc_pos_5_dis = new TH1F("ptpid_tacc_pos_5_dis", "tofw+acc 5 pos kaon accph>5", 80, 0, 8.0);
  TH1F *ptpid_tacc_pos_6_dis = new TH1F("ptpid_tacc_pos_6_dis", "tofw+acc 6 pos kaon accph>10", 80, 0, 8.0);
  TH1F *ptpid_tacc_pos_7_dis = new TH1F("ptpid_tacc_pos_7_dis", "tofw+acc 7 pos kaon accph>15", 80, 0, 8.0);
  TH1F *ptpid_tacc_pos_8_dis = new TH1F("ptpid_tacc_pos_8_dis", "tofw+acc 8 pos proton accph<5", 80, 0, 8.0);
  TH1F *ptpid_tacc_pos_9_dis = new TH1F("ptpid_tacc_pos_9_dis", "tofw+acc 9 pos proton accph>5", 80, 0, 8.0);

  TH1F *ptpid_tacc_neg_0_dis = new TH1F("ptpid_tacc_neg_0_dis", "tofw+acc 0 neg pion accph<5", 80, 0, 8.0);
  TH1F *ptpid_tacc_neg_1_dis = new TH1F("ptpid_tacc_neg_1_dis", "tofw+acc 1 neg pion accph>5", 80, 0, 8.0);
  TH1F *ptpid_tacc_neg_2_dis = new TH1F("ptpid_tacc_neg_2_dis", "tofw+acc 2 neg pion accph>10", 80, 0, 8.0);
  TH1F *ptpid_tacc_neg_3_dis = new TH1F("ptpid_tacc_neg_3_dis", "tofw+acc 3 neg pion accph>15", 80, 0, 8.0);
  TH1F *ptpid_tacc_neg_4_dis = new TH1F("ptpid_tacc_neg_4_dis", "tofw+acc 4 neg kaon accph<5", 80, 0, 8.0);
  TH1F *ptpid_tacc_neg_5_dis = new TH1F("ptpid_tacc_neg_5_dis", "tofw+acc 5 neg kaon accph>5", 80, 0, 8.0);
  TH1F *ptpid_tacc_neg_6_dis = new TH1F("ptpid_tacc_neg_6_dis", "tofw+acc 6 neg kaon accph>10", 80, 0, 8.0);
  TH1F *ptpid_tacc_neg_7_dis = new TH1F("ptpid_tacc_neg_7_dis", "tofw+acc 7 neg kaon accph>15", 80, 0, 8.0);
  TH1F *ptpid_tacc_neg_8_dis = new TH1F("ptpid_tacc_neg_8_dis", "tofw+acc 8 neg proton accph<5", 80, 0, 8.0);
  TH1F *ptpid_tacc_neg_9_dis = new TH1F("ptpid_tacc_neg_9_dis", "tofw+acc 9 neg proton accph>5", 80, 0, 8.0);
  ...
  TH1F *ptpid_tacc_pos_0_dis_cent[10];
  TH1F *ptpid_tacc_pos_1_dis_cent[10];
  TH1F *ptpid_tacc_pos_2_dis_cent[10];
  TH1F *ptpid_tacc_pos_3_dis_cent[10];
  TH1F *ptpid_tacc_pos_4_dis_cent[10];
  TH1F *ptpid_tacc_pos_5_dis_cent[10];
  TH1F *ptpid_tacc_pos_6_dis_cent[10];
  TH1F *ptpid_tacc_pos_7_dis_cent[10];
  TH1F *ptpid_tacc_pos_8_dis_cent[10];
  TH1F *ptpid_tacc_pos_9_dis_cent[10];

  TH1F *ptpid_tacc_neg_0_dis_cent[10];
  TH1F *ptpid_tacc_neg_1_dis_cent[10];
  TH1F *ptpid_tacc_neg_2_dis_cent[10];
  TH1F *ptpid_tacc_neg_3_dis_cent[10];
  TH1F *ptpid_tacc_neg_4_dis_cent[10];
  TH1F *ptpid_tacc_neg_5_dis_cent[10];
  TH1F *ptpid_tacc_neg_6_dis_cent[10];
  TH1F *ptpid_tacc_neg_7_dis_cent[10];
  TH1F *ptpid_tacc_neg_8_dis_cent[10];
  TH1F *ptpid_tacc_neg_9_dis_cent[10];

  char name_ptpid_tacc_pos_0_dis_cent[30];
  char name_ptpid_tacc_pos_1_dis_cent[30];
  char name_ptpid_tacc_pos_2_dis_cent[30];
  char name_ptpid_tacc_pos_3_dis_cent[30];
  char name_ptpid_tacc_pos_4_dis_cent[30];
  char name_ptpid_tacc_pos_5_dis_cent[30];
  char name_ptpid_tacc_pos_6_dis_cent[30];
  char name_ptpid_tacc_pos_7_dis_cent[30];
  char name_ptpid_tacc_pos_8_dis_cent[30];
  char name_ptpid_tacc_pos_9_dis_cent[30];

  char name_ptpid_tacc_neg_0_dis_cent[30];
  char name_ptpid_tacc_neg_1_dis_cent[30];
  char name_ptpid_tacc_neg_2_dis_cent[30];
  char name_ptpid_tacc_neg_3_dis_cent[30];
  char name_ptpid_tacc_neg_4_dis_cent[30];
  char name_ptpid_tacc_neg_5_dis_cent[30];
  char name_ptpid_tacc_neg_6_dis_cent[30];
  char name_ptpid_tacc_neg_7_dis_cent[30];
  char name_ptpid_tacc_neg_8_dis_cent[30];
  char name_ptpid_tacc_neg_9_dis_cent[30];

  for(int i=0; i<9; i++)
    {
      sprintf(name_ptpid_tacc_pos_0_dis_cent,"ptpid_tacc_pos_0_dis_cent_%d",i);
      ptpid_tacc_pos_0_dis_cent[i] = new TH1F(name_ptpid_tacc_pos_0_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_pos_1_dis_cent,"ptpid_tacc_pos_1_dis_cent_%d",i);
      ptpid_tacc_pos_1_dis_cent[i] = new TH1F(name_ptpid_tacc_pos_1_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_pos_2_dis_cent,"ptpid_tacc_pos_2_dis_cent_%d",i);
      ptpid_tacc_pos_2_dis_cent[i] = new TH1F(name_ptpid_tacc_pos_2_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_pos_3_dis_cent,"ptpid_tacc_pos_3_dis_cent_%d",i);
      ptpid_tacc_pos_3_dis_cent[i] = new TH1F(name_ptpid_tacc_pos_3_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_pos_4_dis_cent,"ptpid_tacc_pos_4_dis_cent_%d",i);
      ptpid_tacc_pos_4_dis_cent[i] = new TH1F(name_ptpid_tacc_pos_4_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_pos_5_dis_cent,"ptpid_tacc_pos_5_dis_cent_%d",i);
      ptpid_tacc_pos_5_dis_cent[i] = new TH1F(name_ptpid_tacc_pos_5_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_pos_6_dis_cent,"ptpid_tacc_pos_6_dis_cent_%d",i);
      ptpid_tacc_pos_6_dis_cent[i] = new TH1F(name_ptpid_tacc_pos_6_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_pos_7_dis_cent,"ptpid_tacc_pos_7_dis_cent_%d",i);
      ptpid_tacc_pos_7_dis_cent[i] = new TH1F(name_ptpid_tacc_pos_7_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_pos_8_dis_cent,"ptpid_tacc_pos_8_dis_cent_%d",i);
      ptpid_tacc_pos_8_dis_cent[i] = new TH1F(name_ptpid_tacc_pos_8_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_pos_9_dis_cent,"ptpid_tacc_pos_9_dis_cent_%d",i);
      ptpid_tacc_pos_9_dis_cent[i] = new TH1F(name_ptpid_tacc_pos_9_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_neg_0_dis_cent,"ptpid_tacc_neg_0_dis_cent_%d",i);
      ptpid_tacc_neg_0_dis_cent[i] = new TH1F(name_ptpid_tacc_neg_0_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_neg_1_dis_cent,"ptpid_tacc_neg_1_dis_cent_%d",i);
      ptpid_tacc_neg_1_dis_cent[i] = new TH1F(name_ptpid_tacc_neg_1_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_neg_2_dis_cent,"ptpid_tacc_neg_2_dis_cent_%d",i);
      ptpid_tacc_neg_2_dis_cent[i] = new TH1F(name_ptpid_tacc_neg_2_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_neg_3_dis_cent,"ptpid_tacc_neg_3_dis_cent_%d",i);
      ptpid_tacc_neg_3_dis_cent[i] = new TH1F(name_ptpid_tacc_neg_3_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_neg_4_dis_cent,"ptpid_tacc_neg_4_dis_cent_%d",i);
      ptpid_tacc_neg_4_dis_cent[i] = new TH1F(name_ptpid_tacc_neg_4_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_neg_5_dis_cent,"ptpid_tacc_neg_5_dis_cent_%d",i);
      ptpid_tacc_neg_5_dis_cent[i] = new TH1F(name_ptpid_tacc_neg_5_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_neg_6_dis_cent,"ptpid_tacc_neg_6_dis_cent_%d",i);
      ptpid_tacc_neg_6_dis_cent[i] = new TH1F(name_ptpid_tacc_neg_6_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_neg_7_dis_cent,"ptpid_tacc_neg_7_dis_cent_%d",i);
      ptpid_tacc_neg_7_dis_cent[i] = new TH1F(name_ptpid_tacc_neg_7_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_neg_8_dis_cent,"ptpid_tacc_neg_8_dis_cent_%d",i);
      ptpid_tacc_neg_8_dis_cent[i] = new TH1F(name_ptpid_tacc_neg_8_dis_cent, "...", 80, 0, 8.0);
      sprintf(name_ptpid_tacc_neg_9_dis_cent,"ptpid_tacc_neg_9_dis_cent_%d",i);
      ptpid_tacc_neg_9_dis_cent[i] = new TH1F(name_ptpid_tacc_neg_9_dis_cent, "...", 80, 0, 8.0);
    }
      ...
      for(int i=0;i<n;i++) // loop over events
	{
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      else if(run>=236133&&run<=240121)
		{
	      ...
	      //if(!PC3Fiducial(pc3z,pc3phi)) continue; // old
	      ...
	      //float accph00   = ktree->HadronTracks_accph00[itrk];
	      //float accph01   = ktree->HadronTracks_accph01[itrk];
	      //float accph02   = ktree->HadronTracks_accph02[itrk];
	      //float accph03   = ktree->HadronTracks_accph03[itrk];
	      ...
	      if(striptofw>=256&&striptofw<=511)
		{
	      ...
	      isPi = isPion(pT,m2tofw);
	      isK  = isKaon(pT,m2tofw);
	      isP  = isProton(pT,m2tofw);

	      ngoodacctracks++;
	      ngoodacctracks_snglevent++;
	      
	      if(isPi||isK||isP) naccPIDtracks++;
	      else continue;
	      ...
	      if(charge>0)
		{
		  if(isPi)
		    {
		      if(accph<5) {ptpid_tacc_pos_0_dis->Fill(pT);ptpid_tacc_pos_0_dis_cent[icent]->Fill(pT);}
		      if(accph>=5) {ptpid_tacc_pos_1_dis->Fill(pT);ptpid_tacc_pos_1_dis_cent[icent]->Fill(pT);}
		      if(accph>=10) {ptpid_tacc_pos_2_dis->Fill(pT);ptpid_tacc_pos_2_dis_cent[icent]->Fill(pT);}
		      if(accph>=15) {ptpid_tacc_pos_3_dis->Fill(pT);ptpid_tacc_pos_3_dis_cent[icent]->Fill(pT);}
		    }
		  if(isK)
		    {
		      if(accph<5) {ptpid_tacc_pos_4_dis->Fill(pT);ptpid_tacc_pos_4_dis_cent[icent]->Fill(pT);}
		      if(accph>=5) {ptpid_tacc_pos_5_dis->Fill(pT);ptpid_tacc_pos_5_dis_cent[icent]->Fill(pT);}
		      if(accph>=10) {ptpid_tacc_pos_6_dis->Fill(pT);ptpid_tacc_pos_6_dis_cent[icent]->Fill(pT);}
		      if(accph>=15) {ptpid_tacc_pos_7_dis->Fill(pT);ptpid_tacc_pos_7_dis_cent[icent]->Fill(pT);}
		    }
		  if(isP)
		    {
		      if(accph<5) {ptpid_tacc_pos_8_dis->Fill(pT);ptpid_tacc_pos_8_dis_cent[icent]->Fill(pT);}
		      if(accph>=5) {ptpid_tacc_pos_9_dis->Fill(pT);ptpid_tacc_pos_9_dis_cent[icent]->Fill(pT);}
		    }
		}
	      if(charge<0)
		{
		  if(isPi)
		    {
		      if(accph<5) {ptpid_tacc_neg_0_dis->Fill(pT);ptpid_tacc_neg_0_dis_cent[icent]->Fill(pT);}
		      if(accph>=5) {ptpid_tacc_neg_1_dis->Fill(pT);ptpid_tacc_neg_1_dis_cent[icent]->Fill(pT);}
		      if(accph>=10) {ptpid_tacc_neg_2_dis->Fill(pT);ptpid_tacc_neg_2_dis_cent[icent]->Fill(pT);}
		      if(accph>=15) {ptpid_tacc_neg_3_dis->Fill(pT);ptpid_tacc_neg_3_dis_cent[icent]->Fill(pT);}
		    }
		  if(isK)
		    {
		      if(accph<5) {ptpid_tacc_neg_4_dis->Fill(pT);ptpid_tacc_neg_4_dis_cent[icent]->Fill(pT);}
		      if(accph>=5) {ptpid_tacc_neg_5_dis->Fill(pT);ptpid_tacc_neg_5_dis_cent[icent]->Fill(pT);}
		      if(accph>=10) {ptpid_tacc_neg_6_dis->Fill(pT);ptpid_tacc_neg_6_dis_cent[icent]->Fill(pT);}
		      if(accph>=15) {ptpid_tacc_neg_7_dis->Fill(pT);ptpid_tacc_neg_7_dis_cent[icent]->Fill(pT);}
		    }
		  if(isP)
		    {
		      if(accph<5) {ptpid_tacc_neg_8_dis->Fill(pT);ptpid_tacc_neg_8_dis_cent[icent]->Fill(pT);}
		      if(accph>=5) {ptpid_tacc_neg_9_dis->Fill(pT);ptpid_tacc_neg_9_dis_cent[icent]->Fill(pT);}
		    }
		}
	  ...
	  if(ngoodacctracks_snglevent>0) ngoodaccevents++;
  ...
  cout<<"Number of good ACC events: "<<ngoodaccevents<<endl;
  cout<<"Number of tracks: "<<ntracks<<endl;
  cout<<"Number of good TOFW tracks: "<<ngoodtofwtracks<<endl;
  cout<<"Number of good ACC tracks: "<<ngoodacctracks<<endl;
  cout<<"Number of TOFW PID tracks: "<<ntofwPIDtracks<<endl;
  cout<<"Number of ACC PID tracks: "<<naccPIDtracks<<endl;
...
bool PC3Fiducial(float pc3z, float pc3phi)
{  
  // --- these are the same PC3 fiducial cuts from the Run7 detueron study
  // --- they are only for the region of PC3 where the TOFW resides
  if(fabs(pc3z)<3) return false;
  if(pc3z>-102 && pc3z<-85 && pc3phi>0.40 && pc3phi<0.43) return false;
  if(pc3z>-60 && pc3z<0 && pc3phi>0.40 && pc3phi<0.44) return false;
  if(pc3z>-82 && pc3z<-75 && pc3phi>0.05 && pc3phi<0.07) return false;
  if(pc3z>-80 && pc3z<-60 && pc3phi>-0.075 && pc3phi<-0.04) return false;
  if(pc3z>65 && pc3z<85 && pc3phi>0.48 && pc3phi<0.51) return false;
  if(pc3z>88 && pc3z<105 && pc3phi>-0.02 && pc3phi<0.0) return false;
  return true;
}
